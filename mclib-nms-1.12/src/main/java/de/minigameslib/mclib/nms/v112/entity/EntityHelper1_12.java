 ...
 *
 */
public class EntityHelper1_12 implements EntityHelperInterface
{
    ...
    private static final class PropertyCacheLoader extends CacheLoader<UUID, PropertyMap>
    {
        ...
        public PropertyMap load(UUID key) throws Exception
        {
            ...
            return EntityHelper1_12.getRemoteProfile(player);
        }
    }
    
    /** dummy humans. */
    private static final EntityWithWhitelistHelper<DummyHuman1_12.EntityHelper> HUMANS     = new EntityWithWhitelistHelper<>();
    ...
    public Villager spawnDummyVillager(Location loc, Profession profession)
    {
        try
        {
            CustomEntityType1_12.DUMMY_VILLAGER.registerEntity();
            final DummyVillager1_12 villager = new DummyVillager1_12(((CraftWorld) loc.getWorld()).getHandle());
        ...
        {
            CustomEntityType1_12.DUMMY_VILLAGER.unregisterEntity();
        }
    }
    ...
    public HumanEntity spawnDummyHuman(Location loc, String name, String skinTexture)
    {
        ...
        final DummyHuman1_12 result = new DummyHuman1_12(server, world.getHandle(), profile, new PlayerInteractManager(world.getHandle()), loc);
    ...
    {
        final DummyHuman1_12 human = (DummyHuman1_12) ((CraftPlayer) entity).getHandle();
    ...
    {
        return villager instanceof DummyVillager1_12.VillagerNPC;
    }
    
    @Override
    public boolean isDummyHuman(HumanEntity human)
    {
        return human instanceof DummyHuman1_12.HumanNpc;
    }
