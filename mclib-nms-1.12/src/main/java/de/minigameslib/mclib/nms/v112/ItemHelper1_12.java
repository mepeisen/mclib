...
package de.minigameslib.mclib.nms.v112;
...
import de.minigameslib.mclib.nms.v112.blocks.CustomBlock;
import de.minigameslib.mclib.nms.v112.blocks.CustomDropper;
import de.minigameslib.mclib.nms.v112.blocks.CustomHopper;
import de.minigameslib.mclib.nms.v112.items.ConfigItemStackDataImpl;
import de.minigameslib.mclib.nms.v112.items.CustomArmor;
import de.minigameslib.mclib.nms.v112.items.CustomAxe;
import de.minigameslib.mclib.nms.v112.items.CustomHoe;
import de.minigameslib.mclib.nms.v112.items.CustomItem;
import de.minigameslib.mclib.nms.v112.items.CustomPickaxe;
import de.minigameslib.mclib.nms.v112.items.CustomShovel;
import de.minigameslib.mclib.nms.v112.items.CustomSword;
...
import net.minecraft.server.v1_12_R1.ItemMultiTexture;
 ...
 *
 */
public class ItemHelper1_12 implements ItemHelperInterface
{
    
    /** Logger. */
    private static final Logger LOGGER = Logger.getLogger(ItemHelper1_12.class.getName());
    ...
    public void addCustomData(ItemStack stack, String plugin, String key, String value)
    {
        if (stack instanceof CraftItemStack)
        {
            try
            {
                ...
                final net.minecraft.server.v1_12_R1.ItemStack nms = (net.minecraft.server.v1_12_R1.ItemStack) field.get(stack);
    ...
    public void setBlockVariant(Block block, int type, int variant)
    {
        ...
        ((CraftWorld) block.getWorld()).getHandle().setTypeAndData(position, net.minecraft.server.v1_12_R1.Blocks.AIR.getBlockData(), 0);
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(type);
        @SuppressWarnings("deprecation")
    ...
    public void initBlocks()
    {
        try
        {
            final Method itemMth = Item.class.getDeclaredMethod("a", net.minecraft.server.v1_12_R1.Block.class, Item.class); //$NON-NLS-1$
            ...
            for (int i = MclibConstants.MIN_BLOCK_ID; i <= MclibConstants.MAX_BLOCK_ID; i++)
            {
                ...
                net.minecraft.server.v1_12_R1.Block.REGISTRY.a(i, new MinecraftKey("mclib:custom_" + i), myBlock); //$NON-NLS-1$
                Iterator<IBlockData> iterator2 = myBlock.s().a().iterator();
                while (iterator2.hasNext())
                {
                    IBlockData iblockdata = iterator2.next();
                    int k = net.minecraft.server.v1_12_R1.Block.REGISTRY.a(myBlock) << 4 | myBlock.toLegacyData(iblockdata);
                    net.minecraft.server.v1_12_R1.Block.REGISTRY_ID.a(iblockdata, k);
                }
                
                itemMth.invoke(null, myBlock, new ItemMultiTexture(myBlock, myBlock, new ItemMultiTexture.a() {
                    @Override
                    @Nullable
                    public String a(@Nullable net.minecraft.server.v1_12_R1.ItemStack paramItemStack)
                    {
    ...
    {
        final ItemMeta meta = ItemHelper1_12.getMeta(stack);
    ...
    public void createMinable(Random random, Location location, int blockId, int meta, int size)
    {
        ...
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(blockId);
        @SuppressWarnings("deprecation")
        ...
        while (true)
        {
            ...
            if (firstPartial == -1)
            {
                ...
                if (item.getAmount() > inventory.getMaxStackSize())
                {
                    ...
                    InventoryManager1_12.setContents((CraftInventory) inventory, stack, firstFree);
                    item.setAmount(item.getAmount() - inventory.getMaxStackSize());
                }
                InventoryManager1_12.setContents((CraftInventory) inventory, item, firstFree);
                break;
            }
            ...
            if (amount + partialAmount <= maxAmount)
            {
                ...
                InventoryManager1_12.setContents((CraftInventory) inventory, partialItem, firstPartial);
                break;
            }
    ...
    {
        ((CustomBlock) net.minecraft.server.v1_12_R1.Block.getById(blockId)).setMeta(hardness, resistence, dropRule);
    }
    ...
    {
        RecipesFurnace.getInstance().a(InventoryManager1_12.convertToNms(new ItemStack(blockId, 1, (short) variant)), InventoryManager1_12.convertToNms(stack), experience);
    }
    ...
    {
        RecipesFurnace.getInstance().a(InventoryManager1_12.convertToNms(new ItemStack(itemId, 1)), InventoryManager1_12.convertToNms(receipe), experience);
    }
    ...
    {
        final int shapelines = shape.length;
        final int shapewidth = shape[0].length();
        
        final NonNullList<RecipeItemStack> stacks = NonNullList.a(shapelines * shapewidth, RecipeItemStack.a);
        for (int i = 0; i < shapelines; i++)
        {
            final String shaperow = shape[i];
            for (int j = 0; j < shapewidth; j++)
            {
                final ItemStack mdata = ingred.get(shaperow.charAt(j));

                @SuppressWarnings("deprecation")
                int id = mdata.getTypeId();
                short dmg = mdata.getDurability();
                stacks.set(i * shapewidth + j, RecipeItemStack.a(new net.minecraft.server.v1_12_R1.ItemStack[]{new net.minecraft.server.v1_12_R1.ItemStack(Item.getById(id), mdata.getAmount(), dmg)}));
            }
        }
        final net.minecraft.server.v1_12_R1.ItemStack nms = InventoryManager1_12.convertToNms(item);
        nms.setCount(amount);

        CraftingManager.a(
            new MinecraftKey("mclib", UUID.randomUUID().toString()), //$NON-NLS-1$
            new ShapedRecipes("", shapewidth, shapelines, stacks, nms)); //$NON-NLS-1$
    }
    ...
    public void installShapedRecipe(int blockId, int variant, int amount, String[] shape, Map<Character, ItemStack> ingred)
    {
        ...
        final net.minecraft.server.v1_12_R1.ItemStack nms = new net.minecraft.server.v1_12_R1.ItemStack(Item.getById(blockId), amount, (short) variant);
    ...
    {
        final NonNullList<RecipeItemStack> stacks = NonNullList.a(shapelessItems.length, RecipeItemStack.a);
        for (int i = 0; i < shapelessItems.length; i++)
        {
            final ItemStack mdata = shapelessItems[i];

            @SuppressWarnings("deprecation")
            int id = mdata.getTypeId();
            short dmg = mdata.getDurability();
            stacks.set(i, RecipeItemStack.a(new net.minecraft.server.v1_12_R1.ItemStack[]{new net.minecraft.server.v1_12_R1.ItemStack(Item.getById(id), mdata.getAmount(), dmg)}));
        }
        ...
        CraftingManager.a(
            new MinecraftKey("mclib", UUID.randomUUID().toString()), //$NON-NLS-1$
            new ShapelessRecipes("", nms, stacks)); //$NON-NLS-1$
    }
     ...
     */
    private void replaceModdedBlock(int numBlockId, net.minecraft.server.v1_12_R1.Block block)
    {
        try
        {
            final Field bMapField = net.minecraft.server.v1_12_R1.RegistryMaterials.class.getDeclaredField("b"); //$NON-NLS-1$
            bMapField.setAccessible(true);
            @SuppressWarnings("unchecked")
            final Map<net.minecraft.server.v1_12_R1.Block, MinecraftKey> bMap = (Map<net.minecraft.server.v1_12_R1.Block, MinecraftKey>) bMapField.get(net.minecraft.server.v1_12_R1.Block.REGISTRY);
            
            final Field aMapField = net.minecraft.server.v1_12_R1.RegistryMaterials.class.getDeclaredField("a"); //$NON-NLS-1$
            aMapField.setAccessible(true);
            @SuppressWarnings("unchecked")
            final RegistryID<net.minecraft.server.v1_12_R1.Block> aMap = (RegistryID<net.minecraft.server.v1_12_R1.Block>) aMapField.get(net.minecraft.server.v1_12_R1.Block.REGISTRY);
            
            bMap.put(block, bMap.remove(net.minecraft.server.v1_12_R1.Block.getById(numBlockId)));
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PUMPKIN;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PUMPKIN;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CORAL;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CORAL;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.GRASS;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.GRASS;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.WOOD;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.WOOD;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.STONE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.STONE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.ORE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.ORE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.HEAVY;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.HEAVY;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.WATER;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.WATER;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.LAVA;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.LAVA;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.LEAVES;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.LEAVES;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.REPLACEABLE_PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.REPLACEABLE_PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SPONGE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SPONGE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CLOTH;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CLOTH;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.FIRE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.FIRE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SAND;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SAND;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.ORIENTABLE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.ORIENTABLE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.WOOL;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.WOOL;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SHATTERABLE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SHATTERABLE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.BUILDABLE_GLASS;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.BUILDABLE_GLASS;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.TNT;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.TNT;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.ICE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.ICE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PACKED_ICE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PACKED_ICE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SNOW_LAYER;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SNOW_LAYER;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SNOW_BLOCK;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.SNOW_BLOCK;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CACTUS;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CACTUS;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CLAY;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CLAY;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.DRAGON_EGG;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.DRAGON_EGG;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PORTAL;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PORTAL;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CAKE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.CAKE;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.WEB;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.WEB;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PISTON;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.PISTON;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.BANNER;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.BANNER;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_12_R1.Material.J;
    }
    ...
    {
        final net.minecraft.server.v1_12_R1.Block nms = net.minecraft.server.v1_12_R1.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_12_R1.Material.J;
    }
    
    @Override
    public void initInventory(int blockId, int variant, NmsInventoryHandlerInterface nmsInventoryHandler)
    {
        final CustomBlock block = (CustomBlock) net.minecraft.server.v1_12_R1.Block.getById(blockId);
    ...
    public Map<String, Integer> getBlockMappings()
    {
        ...
        for (final MinecraftKey key : net.minecraft.server.v1_12_R1.Block.REGISTRY.keySet())
        {
            final String name = key.toString();
            for (int i = 0; i < 16; i++)
            {
                final net.minecraft.server.v1_12_R1.Block block = net.minecraft.server.v1_12_R1.Block.REGISTRY.get(key);
                final int numid = net.minecraft.server.v1_12_R1.Block.REGISTRY.a(block);
        ...
        for (int x = 0; x < 16; x++)
        {
            ...
            for (int y = 0; y < 256; y++)
            {
                ...
                for (int z = 0; z < 16; z++)
                {
                    ...
                    blockData[x][y][z] = net.minecraft.server.v1_12_R1.Block.REGISTRY_ID.getId(data);
                }
            }
        }
    ...
    public void loadTileEntities(Location loc, List<TileEntityData> data)
    {
        for (final TileEntityData tiledata : data)
        {
            ...
            ((CraftChunk)newLoc.getChunk()).getHandle().tileEntities.put(
                ...
                TileEntity.a(((CraftWorld)loc.getWorld()).getHandle(), tag));
        }
    }
