...
package de.minigameslib.mclib.nms.v112.items;
...
public class ConfigItemStackDataImpl extends AnnotatedDataFragment implements ConfigItemStackData
{
    ...
    {
        final net.minecraft.server.v1_12_R1.ItemStack nms = CraftItemStack.asNMSCopy(stack);
        final MinecraftKey mckey = nms == null ? null : Item.REGISTRY.b(nms.getItem());
        this.mcid = mckey == null ? "minecraft:air" : mckey.toString(); //$NON-NLS-1$
        
        this.amount = nms == null ? 1 : nms.getCount();
    ...
    {
        final net.minecraft.server.v1_12_R1.ItemStack stack = new net.minecraft.server.v1_12_R1.ItemStack(
            Item.b(this.mcid),
            this.amount,
            this.damage);
