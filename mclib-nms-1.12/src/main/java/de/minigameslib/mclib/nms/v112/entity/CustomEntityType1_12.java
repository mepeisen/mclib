 ...
 * @see EntityTypes
 */
public enum CustomEntityType1_12
{
    
    /** a dummy villager. */
    DUMMY_VILLAGER("villager", 120, EntityType.VILLAGER, EntityVillager.class, DummyVillager1_12.class); //$NON-NLS-1$
    ...
    /** logger. */
    private static final Logger               LOGGER = Logger.getLogger(CustomEntityType1_12.class.getName());
     ...
     *            custom class
     */
    private CustomEntityType1_12(String name, int id, EntityType entityType, Class<? extends EntityInsentient> nmsClass, Class<? extends EntityInsentient> customClass)
    {
        this.name = name;
        this.id = id;
    ...
    {
        for (CustomEntityType1_12 entity : values())
        {
     ...
     *            entity type id
     */
    private static void register(Class<? extends Entity> paramClass, String paramString, int paramInt)
    {
        EntityTypes.b.a(64, new MinecraftKey(paramString), paramClass);
    }
}
