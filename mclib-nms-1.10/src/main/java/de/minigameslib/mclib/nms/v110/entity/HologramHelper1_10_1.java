...
public class HologramHelper1_10_1 implements HologramHelperInterface
{
    ...
    static
    {
        try
        {
            final Field entityField = net.minecraft.server.v1_10_R1.Entity.class.getDeclaredField("aA"); //$NON-NLS-1$
