...
import de.minigames.mclib.nms.v18.blocks.CustomDropper;
import de.minigames.mclib.nms.v18.blocks.CustomHopper;
import de.minigames.mclib.nms.v18.items.ConfigItemStackDataImpl;
import de.minigames.mclib.nms.v18.items.CustomArmor;
import de.minigames.mclib.nms.v18.items.CustomAxe;
import de.minigames.mclib.nms.v18.items.CustomHoe;
import de.minigames.mclib.nms.v18.items.CustomItem;
import de.minigames.mclib.nms.v18.items.CustomPickaxe;
import de.minigames.mclib.nms.v18.items.CustomShovel;
...
public class ItemHelper1_8 implements ItemHelperInterface
{
    ...
    /** Logger. */
    private static final Logger LOGGER = Logger.getLogger(ItemHelper1_8.class.getName());
    ...
    public void setBlockVariant(Block block, int type, int variant)
    {
        ...
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(type);
        @SuppressWarnings("deprecation")
    ...
    {
        final ItemMeta meta = ItemHelper1_8.getMeta(stack);
    ...
    {
        RecipesFurnace.getInstance().a(InventoryManager1_8.convertToNms(new ItemStack(blockId, 1, (short) variant)), InventoryManager1_8.convertToNms(stack), experience);
    }
    ...
    {
        RecipesFurnace.getInstance().a(InventoryManager1_8.convertToNms(new ItemStack(itemId, 1)), InventoryManager1_8.convertToNms(receipe), experience);
    }
    ...
    public void installShapedRecipe(ItemStack item, int amount, String[] shape, Map<Character, ItemStack> ingred)
    {
        ...
        for (Iterator<Character> localIterator = ingred.keySet().iterator(); localIterator.hasNext();)
        {
            ...
            if (mdata != null)
            {
                ...
                data[i] = new net.minecraft.server.v1_8_R1.ItemStack(Item.getById(id), mdata.getAmount(), dmg);
                ++i;
            }
        }
        final net.minecraft.server.v1_8_R1.ItemStack nms = InventoryManager1_8.convertToNms(item);
        nms.count = amount;
    ...
    public void installShapedRecipe(int blockId, int variant, int amount, String[] shape, Map<Character, ItemStack> ingred)
    {
        ...
        final net.minecraft.server.v1_8_R1.ItemStack nms = new net.minecraft.server.v1_8_R1.ItemStack(Item.getById(blockId), amount, (short) variant);
        CraftingManager.getInstance().registerShapedRecipe(nms, data);
        CraftingManager.getInstance().sort();
    }
     ...
     */
    private void replaceModdedBlock(int numBlockId, net.minecraft.server.v1_8_R1.Block block)
    {
        try
        {
            final Field bMapField = net.minecraft.server.v1_8_R1.RegistryMaterials.class.getDeclaredField("b"); //$NON-NLS-1$
            bMapField.setAccessible(true);
            @SuppressWarnings("unchecked")
            final Map<net.minecraft.server.v1_8_R1.Block, MinecraftKey> bMap = (Map<net.minecraft.server.v1_8_R1.Block, MinecraftKey>) bMapField.get(net.minecraft.server.v1_8_R1.Block.REGISTRY);
            
            final Field aMapField = net.minecraft.server.v1_8_R1.RegistryMaterials.class.getDeclaredField("a"); //$NON-NLS-1$
            aMapField.setAccessible(true);
            @SuppressWarnings("unchecked")
            final RegistryID aMap = (RegistryID) aMapField.get(net.minecraft.server.v1_8_R1.Block.REGISTRY);
            
            bMap.put(block, bMap.remove(net.minecraft.server.v1_8_R1.Block.getById(numBlockId)));
    ...
    private void replaceModdedItem(int itemId, Item newItem)
    {
        try
        {
            ...
            final Field aMapField = net.minecraft.server.v1_8_R1.RegistryMaterials.class.getDeclaredField("a"); //$NON-NLS-1$
            aMapField.setAccessible(true);
            final RegistryID aMap = (RegistryID) aMapField.get(Item.REGISTRY);
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.PLANT;
    }
    
    @Override
    public boolean isPlant(int block)
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.PUMPKIN;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.PUMPKIN;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.CORAL;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.CORAL;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.GRASS;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.GRASS;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.WOOD;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.WOOD;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.STONE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.STONE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.ORE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.ORE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.HEAVY;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.HEAVY;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.WATER;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.WATER;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.LAVA;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.LAVA;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.LEAVES;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.LEAVES;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.REPLACEABLE_PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.REPLACEABLE_PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.SPONGE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.SPONGE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.CLOTH;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.CLOTH;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.FIRE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.FIRE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.SAND;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.SAND;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.ORIENTABLE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.ORIENTABLE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.WOOL;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.WOOL;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.SHATTERABLE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.SHATTERABLE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.BUILDABLE_GLASS;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.BUILDABLE_GLASS;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.TNT;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.TNT;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.ICE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.ICE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.PACKED_ICE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.PACKED_ICE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.SNOW_LAYER;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.SNOW_LAYER;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.SNOW_BLOCK;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.SNOW_BLOCK;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.CACTUS;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.CACTUS;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.CLAY;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.CLAY;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.DRAGON_EGG;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.DRAGON_EGG;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.PORTAL;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.PORTAL;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.CAKE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.CAKE;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.WEB;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.WEB;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.PISTON;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.PISTON;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block block = net.minecraft.server.v1_8_R1.Block.getById(material.getId());
        return block.getMaterial() == net.minecraft.server.v1_8_R1.Material.BANNER;
    }
    ...
    {
        final net.minecraft.server.v1_8_R1.Block nms = net.minecraft.server.v1_8_R1.Block.getById(block);
        return nms.getMaterial() == net.minecraft.server.v1_8_R1.Material.BANNER;
    }
    ...
    {
        final CustomBlock block = (CustomBlock) net.minecraft.server.v1_8_R1.Block.getById(blockId);
