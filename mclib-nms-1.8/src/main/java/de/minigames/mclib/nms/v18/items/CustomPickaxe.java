...
import net.minecraft.server.v1_8_R1.EnumToolMaterial;
import net.minecraft.server.v1_8_R1.GenericAttributes;
import net.minecraft.server.v1_8_R1.Item;
import net.minecraft.server.v1_8_R1.ItemPickaxe;
...
public class CustomPickaxe extends ItemPickaxe
{
    ...
    public Multimap i()
    {
        ...
        localMultimap.put(GenericAttributes.e.getName(), new AttributeModifier(f, "Tool modifier", this.attackDmg, 0)); //$NON-NLS-1$
