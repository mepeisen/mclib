 ...
 * @author mepeisen
 */
public class LocalizedLinesEditLocaleList extends PagableClickGuiPage<String>
{
    ...
    protected ClickGuiItem map(int line, int col, int index, String elm)
    {
        ...
        {
            return GuiServiceInterface.itemNew((p, s, g) -> this.onCreateBefore(p, s, g, realLine), Messages.IconCreateBefore);
        }
        if (elm.equals(CREATE_AFTER_MARKER))
        {
            return GuiServiceInterface.itemNew((p, s, g) -> this.onCreateAfter(p, s, g, realLine), Messages.IconCreateAfter);
        }
        if (elm.equals(DELETE_MARKER))
        {
            return GuiServiceInterface.itemDelete((p, s, g) -> this.onDeleteLine(p, s, g, realLine), Messages.IconDeleteLine);
        }
    ...
    protected ClickGuiItem[] firstLine()
    {
        return new ClickGuiItem[] {
            ...
            null,
            GuiServiceInterface.itemDelete(this.onDelete, Messages.IconDeleteAll),
            null,
     ...
     * @author mepeisen
     */
    @LocalizedMessages(value = "gui.line_edit_locale_list")
