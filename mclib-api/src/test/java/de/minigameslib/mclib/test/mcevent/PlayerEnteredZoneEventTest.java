...
/**
 * Test for {@link PlayerEnteredZoneEvent}.
 * 
 * @author mepeisen
 */
public class PlayerEnteredZoneEventTest
{
    ...
    public void testMe()
    {
        ...
        final PlayerEnteredZoneEvent evt = new PlayerEnteredZoneEvent(zone, player);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), PlayerEnteredZoneEvent.getHandlerList());
