...
/**
 * Test for {@link SignDeletedEvent}.
 * 
 * @author mepeisen
 */
public class SignDeletedEventTest
{
    ...
    public void testMe()
    {
        ...
        final SignDeletedEvent evt = new SignDeletedEvent(Sign);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), SignDeletedEvent.getHandlerList());
