...
/**
 * Test for {@link ZoneCreatedEvent}.
 * 
 * @author mepeisen
 */
public class ZoneCreatedEventTest
{
    ...
    public void testMe()
    {
        ...
        final ZoneCreatedEvent evt = new ZoneCreatedEvent(zone);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ZoneCreatedEvent.getHandlerList());
