...
/**
 * Test for {@link SignCreateEvent}.
 * 
 * @author mepeisen
 */
public class SignCreateEventTest
{
    ...
    public void testMe()
    {
        ...
        final SignCreateEvent evt = new SignCreateEvent(Sign);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), SignCreateEvent.getHandlerList());
