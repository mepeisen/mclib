...
/**
 * Tests for {@link BlockVariantId}.
 * 
 * @author mepeisen
 *
 */
public class BlockVariantIdTest
{
    ...
    {
        assertTrue(TestBlocks.Common.isOpaque());
        assertFalse(TestBlocks.Empty.isOpaque());
    }
     ...
     */
    @Test(expected = IllegalStateException.class)
    public void testOpaqueInvalid()
    {
        new InvalidBlock().isOpaque();
    }
     ...
     * test items.
     */
    private enum TestBlocks implements BlockVariantId
    {
     ...
     * test items.
     */
    private static final class InvalidBlock implements BlockVariantId
    {
