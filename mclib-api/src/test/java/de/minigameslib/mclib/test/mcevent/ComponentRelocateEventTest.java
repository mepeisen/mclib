...
/**
 * Test for {@link ComponentRelocateEvent}.
 * 
 * @author mepeisen
 */
public class ComponentRelocateEventTest
{
    ...
    public void testMe()
    {
        ...
        final ComponentRelocateEvent evt = new ComponentRelocateEvent(Component,
        ...
        assertSame(evt.getHandlers(), ComponentRelocateEvent.getHandlerList());
