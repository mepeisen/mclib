...
/**
 * Test for {@link ObjectCreateEvent}.
 * 
 * @author mepeisen
 */
public class ObjectCreateEventTest
{
    ...
    public void testMe()
    {
        ...
        final ObjectCreateEvent evt = new ObjectCreateEvent(Object);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ObjectCreateEvent.getHandlerList());
