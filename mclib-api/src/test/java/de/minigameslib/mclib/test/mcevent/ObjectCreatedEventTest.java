...
/**
 * Test for {@link ObjectCreatedEvent}.
 * 
 * @author mepeisen
 */
public class ObjectCreatedEventTest
{
    ...
    public void testMe()
    {
        ...
        final ObjectCreatedEvent evt = new ObjectCreatedEvent(Object);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ObjectCreatedEvent.getHandlerList());
