...
/**
 * Test for {@link ZoneRelocateEvent}.
 * 
 * @author mepeisen
 */
public class ZoneRelocateEventTest
{
    ...
    public void testMe()
    {
        ...
        final ZoneRelocateEvent evt = new ZoneRelocateEvent(zone,
            new Cuboid(
        ...
        assertSame(evt.getHandlers(), ZoneRelocateEvent.getHandlerList());
