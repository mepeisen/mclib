...
/**
 * Test for {@link ComponentCreateEvent}.
 * 
 * @author mepeisen
 */
public class ComponentCreateEventTest
{
    ...
    public void testMe()
    {
        ...
        final ComponentCreateEvent evt = new ComponentCreateEvent(Component);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ComponentCreateEvent.getHandlerList());
