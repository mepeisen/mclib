...
/**
 * Test for {@link SignCreatedEvent}.
 * 
 * @author mepeisen
 */
public class SignCreatedEventTest
{
    ...
    public void testMe()
    {
        ...
        final SignCreatedEvent evt = new SignCreatedEvent(Sign);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), SignCreatedEvent.getHandlerList());
