...
/**
 * Test for {@link EntityDeletedEvent}.
 * 
 * @author mepeisen
 */
public class EntityDeletedEventTest
{
    ...
    public void testMe()
    {
        ...
        final EntityDeletedEvent evt = new EntityDeletedEvent(Entity);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), EntityDeletedEvent.getHandlerList());
