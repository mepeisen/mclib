...
/**
 * Test for {@link SignDeleteEvent}.
 * 
 * @author mepeisen
 */
public class SignDeleteEventTest
{
    ...
    public void testMe()
    {
        ...
        final SignDeleteEvent evt = new SignDeleteEvent(Sign);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), SignDeleteEvent.getHandlerList());
