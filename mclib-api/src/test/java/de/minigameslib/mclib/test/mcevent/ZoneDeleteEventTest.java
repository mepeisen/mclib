...
/**
 * Test for {@link ZoneDeleteEvent}.
 * 
 * @author mepeisen
 */
public class ZoneDeleteEventTest
{
    ...
    public void testMe()
    {
        ...
        final ZoneDeleteEvent evt = new ZoneDeleteEvent(zone);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ZoneDeleteEvent.getHandlerList());
