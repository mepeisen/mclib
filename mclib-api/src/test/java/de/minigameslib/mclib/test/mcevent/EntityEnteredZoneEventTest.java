...
/**
 * Test for {@link EntityEnteredZoneEvent}.
 * 
 * @author mepeisen
 */
public class EntityEnteredZoneEventTest
{
    ...
    public void testMe() throws ClassNotFoundException
    {
        ...
        final EntityEnteredZoneEvent evt = new EntityEnteredZoneEvent(zone, entity);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), EntityEnteredZoneEvent.getHandlerList());
