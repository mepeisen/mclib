...
/**
 * Test for {@link ZoneRelocatedEvent}.
 * 
 * @author mepeisen
 */
public class ZoneRelocatedEventTest
{
    ...
    public void testMe()
    {
        ...
        final ZoneRelocatedEvent evt = new ZoneRelocatedEvent(zone,
            new Cuboid(
                new Location(null, 1, 2, 3),
                new Location(null, 2, 3, 4)),
            new Cuboid(
                new Location(null, 2, 2, 3),
                new Location(null, 3, 3, 4)));

        assertEquals(new Cuboid(
            new Location(null, 1, 2, 3),
            new Location(null, 2, 3, 4)),
            evt.getOldCuboid());
        assertEquals(new Cuboid(
        ...
        assertSame(evt.getHandlers(), ZoneRelocatedEvent.getHandlerList());
