 ...
 * <dd>Not supported</dd>
 * <dt>Arena-Rule</dt>
 * <dd>Passed to the arena calculated from the block location (=the block being built)</dd>
 * <dt>Minigame-Rule</dt>
 ...
 * @author mepeisen
 */
public interface McBlockCanBuildEvent extends MinecraftEvent<BlockCanBuildEvent, McBlockCanBuildEvent>
{
