...
/**
 * An event fired before an existing object is deleted.
 * 
 * <p>
 * This event can be cancelled. If cancelled the object will not be deleted.
 * </p>
 * 
 * @author mepeisen
 */
public class ObjectDeleteEvent extends AbstractVetoEvent implements MinecraftEvent<ObjectDeleteEvent, ObjectDeleteEvent>
{
     ...
     *            the deleted object.
     */
    public ObjectDeleteEvent(ObjectInterface object)
    {
        this.object = object;
    }
