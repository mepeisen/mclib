...
/**
 * Similar to {@link java.util.function.LongUnaryOperator} but is able to throw McExceptions.
 * 
 * @author mepeisen
 *
 */
@FunctionalInterface
public interface McLongUnaryOperator
{
     ...
     */
    long applyAsLong(long operand) throws McException;
     ...
     *             if before is null
     *
     * @see #andThen(McLongUnaryOperator)
     */
    default McLongUnaryOperator compose(McLongUnaryOperator before)
    {
     ...
     *             if after is null
     *
     * @see #compose(McLongUnaryOperator)
     */
    default McLongUnaryOperator andThen(McLongUnaryOperator after)
    {
     ...
     */
    static McLongUnaryOperator identity()
    {
        return t -> t;
    }
