...
/**
 * Similar to {@link java.util.function.LongConsumer} but is able to throw McExceptions.
 * 
 * @author mepeisen
 *
 */
@FunctionalInterface
public interface McLongConsumer
{
     ...
     */
    void accept(long value) throws McException;
