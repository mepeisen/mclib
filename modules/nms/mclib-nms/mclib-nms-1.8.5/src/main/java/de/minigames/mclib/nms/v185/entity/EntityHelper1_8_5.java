 ...
 *
 */
public class EntityHelper1_8_5 implements EntityHelperInterface
{
    ...
    private static final class PropertyCacheLoader extends CacheLoader<UUID, PropertyMap>
    {
        ...
        public PropertyMap load(UUID key) throws Exception
        {
            ...
            return EntityHelper1_8_5.getRemoteProfile(player);
        }
    }
    
    /** dummy humans. */
    private static final EntityWithWhitelistHelper<DummyHuman1_8_5.EntityHelper> HUMANS     = new EntityWithWhitelistHelper<>();
    ...
    public Villager spawnDummyVillager(Location loc, Profession profession)
    {
        try
        {
            CustomEntityType1_8_5.DUMMY_VILLAGER.registerEntity();
            final DummyVillager1_8_5 villager = new DummyVillager1_8_5(((CraftWorld) loc.getWorld()).getHandle());
        ...
        {
            CustomEntityType1_8_5.DUMMY_VILLAGER.unregisterEntity();
        }
    }
    ...
    public HumanEntity spawnDummyHuman(Location loc, String name, String skinTexture)
    {
        ...
        final DummyHuman1_8_5 result = new DummyHuman1_8_5(server, world.getHandle(), profile, new PlayerInteractManager(world.getHandle()), loc);
    ...
    {
        final DummyHuman1_8_5 human = (DummyHuman1_8_5) ((CraftPlayer) entity).getHandle();
    ...
    {
        final MinecraftSessionService sessionService = ((CraftServer) Bukkit.getServer()).getServer().aD();
    ...
    {
        return villager instanceof DummyVillager1_8_5.VillagerNPC;
    }
    
    @Override
    public boolean isDummyHuman(HumanEntity human)
    {
        return human instanceof DummyHuman1_8_5.HumanNpc;
    }
