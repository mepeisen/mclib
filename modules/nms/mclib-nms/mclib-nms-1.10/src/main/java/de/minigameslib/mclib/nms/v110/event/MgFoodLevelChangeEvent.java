...
import de.minigameslib.mclib.api.event.McFoodLevelChangeEvent;
 ...
 * @author mepeisen
 */
public class MgFoodLevelChangeEvent extends AbstractMinigameEvent<FoodLevelChangeEvent, McFoodLevelChangeEvent> implements McFoodLevelChangeEvent
{
     ...
     * @param event
     */
    public MgFoodLevelChangeEvent(FoodLevelChangeEvent event)
    {
     ...
     * @return player
     */
    private static McPlayerInterface player(FoodLevelChangeEvent event)
    {
     ...
     * @return arena
     */
    private static ZoneInterface location(FoodLevelChangeEvent event)
    {
        final Entity passenger = event.getEntity();
