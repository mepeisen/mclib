 ...
 * @see EntityTypes
 */
public enum CustomEntityType1_10_1
{
    
    /** a dummy villager. */
    DUMMY_VILLAGER("Villager", 120, EntityType.VILLAGER, EntityVillager.class, DummyVillager1_10_1.class); //$NON-NLS-1$
    ...
    /** logger. */
    private static final Logger               LOGGER = Logger.getLogger(CustomEntityType1_10_1.class.getName());
     ...
     *            custom class
     */
    private CustomEntityType1_10_1(String name, int id, EntityType entityType, Class<? extends EntityInsentient> nmsClass, Class<? extends EntityInsentient> customClass)
    {
        this.name = name;
        this.id = id;
