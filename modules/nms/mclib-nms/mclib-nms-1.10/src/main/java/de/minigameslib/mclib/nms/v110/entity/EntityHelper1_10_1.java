 ...
 *
 */
public class EntityHelper1_10_1 implements EntityHelperInterface
{
    ...
    private static final class PropertyCacheLoader extends CacheLoader<UUID, PropertyMap>
    {
        ...
        public PropertyMap load(UUID key) throws Exception
        {
            ...
            return EntityHelper1_10_1.getRemoteProfile(player);
        }
    }
    
    /** dummy humans. */
    private static final EntityWithWhitelistHelper<DummyHuman1_10_1.EntityHelper> HUMANS     = new EntityWithWhitelistHelper<>();
    ...
    public Villager spawnDummyVillager(Location loc, Profession profession)
    {
        try
        {
            CustomEntityType1_10_1.DUMMY_VILLAGER.registerEntity();
            final DummyVillager1_10_1 villager = new DummyVillager1_10_1(((CraftWorld) loc.getWorld()).getHandle());
        ...
        {
            CustomEntityType1_10_1.DUMMY_VILLAGER.unregisterEntity();
        }
    }
    ...
    {
        final DummyHuman1_10_1 human = (DummyHuman1_10_1) ((CraftPlayer) entity).getHandle();
    ...
    {
        return villager instanceof DummyVillager1_10_1.VillagerNPC;
    }
