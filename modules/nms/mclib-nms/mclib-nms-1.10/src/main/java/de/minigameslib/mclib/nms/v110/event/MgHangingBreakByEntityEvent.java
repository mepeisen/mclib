...
import de.minigameslib.mclib.api.event.McHangingBreakByEntityEvent;
...
public class MgHangingBreakByEntityEvent extends AbstractMinigameEvent<HangingBreakByEntityEvent, McHangingBreakByEntityEvent> implements McHangingBreakByEntityEvent
{
     ...
     * @return player
     */
    private static McPlayerInterface player(HangingBreakByEntityEvent event)
    {
     ...
     * @return arena
     */
    private static ZoneInterface location(HangingBreakByEntityEvent event)
    {
        final Entity passenger = event.getRemover();
