...
public class CustomBlock extends Block
{
    ...
    public boolean interact(World paramWorld, BlockPosition paramBlockPosition, IBlockData paramIBlockData,
        net.minecraft.server.v1_10_R1.EntityHuman paramEntityHuman, net.minecraft.server.v1_10_R1.EnumHand paramEnumHand, ItemStack itemStack,
        net.minecraft.server.v1_10_R1.EnumDirection paramEnumDirection, float paramFloat1,
