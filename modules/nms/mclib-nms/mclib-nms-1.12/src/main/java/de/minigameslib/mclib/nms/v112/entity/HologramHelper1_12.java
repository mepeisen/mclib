...
public class HologramHelper1_12 implements HologramHelperInterface
{
    ...
    static
    {
        try
        {
            final Field entityField = net.minecraft.server.v1_12_R1.Entity.class.getDeclaredField("aA"); //$NON-NLS-1$
