 ...
 *
 */
public class DummyHuman1_12 extends EntityPlayer
{
     ...
     *            spawn location
     */
    public DummyHuman1_12(MinecraftServer minecraftserver, WorldServer worldserver, GameProfile gameprofile, PlayerInteractManager playerinteractmanager, Location loc)
    {
    ...
    protected static final class HumanNpc extends CraftPlayer
    {
         ...
         *            nms handle
         */
        public HumanNpc(DummyHuman1_12 handle)
        {
    ...
    public final class EntityHelper extends AbstractWhitelistableEntityHelper
    {
        ...
        {
            return DummyHuman1_12.this.getBukkitEntity().getLocation();
        }
        
        @Override
        protected void sendInRangePackages(Player player, PlayerConnection con)
        {
            final byte encodedyaw = toAngle(DummyHuman1_12.this.yaw);
            float body = DummyHuman1_12.this.yaw + 45;
            if (body >= 180)
            {
                body -= 360;
            }
            ...
            sendPackages(con, 1,
                new PacketPlayOutEntityDestroy(DummyHuman1_12.this.getId()),
                new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.ADD_PLAYER, DummyHuman1_12.this),
                new PacketPlayOutNamedEntitySpawn(DummyHuman1_12.this));
            sendPackages(con, 2,
                new PacketPlayOutEntityHeadRotation(DummyHuman1_12.this, encodedyaw),
                new PacketPlayOutEntity.PacketPlayOutEntityLook(DummyHuman1_12.this.getId(), encodedbody, toAngle(DummyHuman1_12.this.pitch), true));
            sendPackages(con, 4,
                new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.REMOVE_PLAYER, DummyHuman1_12.this));
        }
        ...
        {
            con.sendPacket(new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.REMOVE_PLAYER, DummyHuman1_12.this));
        }
