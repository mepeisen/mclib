 ...
 * @author mepeisen
 */
public class MgPlayerTeleportEvent extends AbstractMinigameEvent<PlayerTeleportEvent, McPlayerTeleportEvent> implements McPlayerTeleportEvent
{
     ...
     *            the bukkit event
     */
    public MgPlayerTeleportEvent(PlayerTeleportEvent event)
    {
