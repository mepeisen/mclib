...
import de.minigameslib.mclib.nms.v112.event.*;
...
public class EventSystem1_12 extends AbstractEventSystem
{
    
    /**
     * Constructor.
     */
    public EventSystem1_12()
    {
        super();
        ...
        this.registerHandler(EntityBreedEvent.class, McEntityBreedEvent.class, (evt) -> new MgEntityBreedEvent(evt));
