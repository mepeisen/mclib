                        ...
                        if (newInRange != oldInRange)
                        {
                            if (!oldInRange)
                            {
                                ...
                                new BukkitRunnable() {
                                    ...
                                    public void run()
                                    {
                                        con.sendPacket(new PacketPlayOutEntityDestroy(DummyHuman1_9.this.getId()));
                                        con.sendPacket(new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.ADD_PLAYER, DummyHuman1_9.this));
                                        con.sendPacket(new PacketPlayOutNamedEntitySpawn(DummyHuman1_9.this));
                                    }
