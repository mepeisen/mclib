 ...
 * @author mepeisen
 */
public class MgPlayerJoinEvent extends AbstractMinigameEvent<PlayerJoinEvent, McPlayerJoinEvent> implements McPlayerJoinEvent
{
     ...
     *            the bukkit event
     */
    public MgPlayerJoinEvent(PlayerJoinEvent event)
    {
