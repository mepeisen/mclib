...
public class EntityHelper1_9 implements EntityHelperInterface
{
    ...
    public Villager spawnDummyVillager(Location loc, Profession profession)
    {
        try
        {
            CustomEntityType1_9.DUMMY_VILLAGER.registerEntity();
            final DummyVillager1_9 villager = new DummyVillager1_9(((CraftWorld) loc.getWorld()).getHandle());
        ...
        {
            CustomEntityType1_9.DUMMY_VILLAGER.unregisterEntity();
        }
    }
    ...
    {
        return villager instanceof DummyVillager1_9.VillagerNPC;
    }
    
    @Override
    public boolean isDummyHuman(HumanEntity human)
    {
        return human instanceof DummyHuman1_9.HumanNpc;
    }
