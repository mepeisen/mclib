...
public class ConfigItemStackDataImpl extends AnnotatedDataFragment implements ConfigItemStackData
{
    ...
    {
        final net.minecraft.server.v1_9_R1.ItemStack nms = CraftItemStack.asNMSCopy(stack);
    ...
    {
        final net.minecraft.server.v1_9_R1.ItemStack stack = new net.minecraft.server.v1_9_R1.ItemStack(
                Item.d(this.mcid),
                this.amount,
                this.damage);
