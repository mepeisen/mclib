...
import de.minigameslib.mclib.api.event.McProjectileHitEvent;
...
public class MgProjectileHitEvent extends AbstractMinigameEvent<ProjectileHitEvent, McProjectileHitEvent> implements McProjectileHitEvent
{
     ...
     * @return player
     */
    private static McPlayerInterface player(ProjectileHitEvent event)
    {
     ...
     * @return arena
     */
    private static ZoneInterface location(ProjectileHitEvent event)
    {
        final ProjectileSource source = event.getEntity().getShooter();
