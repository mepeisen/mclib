...
package de.minigames.mclib.nms.v18.items;
...
public class ConfigItemStackDataImpl extends AnnotatedDataFragment implements ConfigItemStackData
{
    ...
    {
        final net.minecraft.server.v1_8_R1.ItemStack nms = CraftItemStack.asNMSCopy(stack);
        final MinecraftKey mckey = nms == null ? null : (MinecraftKey) Item.REGISTRY.c(nms.getItem());
    ...
    {
        final net.minecraft.server.v1_8_R1.ItemStack stack = new net.minecraft.server.v1_8_R1.ItemStack(
                Item.d(this.mcid),
                this.amount,
                this.damage);
