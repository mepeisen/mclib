...
public class ItemHelper1_8 implements ItemHelperInterface
{
    ...
    public void initItems()
    {
        try
        {
            final Method itemMth = net.minecraft.server.v1_8_R1.Item.class.getDeclaredMethod("a", int.class, String.class, net.minecraft.server.v1_8_R1.Item.class); //$NON-NLS-1$
            itemMth.setAccessible(true);
