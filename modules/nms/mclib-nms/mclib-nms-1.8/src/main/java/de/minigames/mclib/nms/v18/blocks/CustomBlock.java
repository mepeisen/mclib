...
public class CustomBlock extends Block
{
    ...
    public void postPlace(World world, BlockPosition blockposition, IBlockData iblockdata,
        net.minecraft.server.v1_8_R1.EntityLiving entityliving, net.minecraft.server.v1_8_R1.ItemStack itemstack)
    {
        final NmsInventoryHandlerInterface handler = this.inventoryHandler.get(this.toLegacyData(iblockdata));
        if (handler != null)
        {
    ...
    public boolean interact(World paramWorld, BlockPosition paramBlockPosition, IBlockData paramIBlockData,
        net.minecraft.server.v1_8_R1.EntityHuman paramEntityHuman, net.minecraft.server.v1_8_R1.EnumDirection paramEnumDirection, float paramFloat1,
     ...
     * @return block face
     */
    private BlockFace toBlockFace(net.minecraft.server.v1_8_R1.EnumDirection paramEnumDirection)
    {
    ...
    @Override
    public net.minecraft.server.v1_8_R1.Item getDropType(IBlockData iblockdata, Random random, int fortune)
    {
        return this.dropRule == null
            ? super.getDropType(iblockdata, random, fortune)
                : net.minecraft.server.v1_8_R1.Item.getById(this.dropRule.getDropType(this.toLegacyData(iblockdata), random, fortune));
    }
    ...
    @Override
    public int getExpDrop(net.minecraft.server.v1_8_R1.World world, IBlockData data, int enchantmentLevel)
    {
