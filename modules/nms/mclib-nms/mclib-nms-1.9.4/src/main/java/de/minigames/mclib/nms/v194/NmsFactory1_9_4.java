...
import de.minigames.mclib.nms.v194.entity.SignHelper1_9_4;
 ...
 * @author mepeisen
 */
public class NmsFactory1_9_4 implements NmsFactory
{
     ...
     * Constructor.
     */
    public NmsFactory1_9_4()
    {
        this.impls.put(EventSystemInterface.class, EventSystem1_9_4::new);
        this.impls.put(InventoryManagerInterface.class, InventoryManager1_9_4::new);
        ...
        this.impls.put(SignHelperInterface.class, SignHelper1_9_4::new);
    }
