...
public class HologramHelper1_9_4 implements HologramHelperInterface
{
    ...
    static
    {
        try
        {
            final Field entityField = net.minecraft.server.v1_9_R2.Entity.class.getDeclaredField("aA"); //$NON-NLS-1$
