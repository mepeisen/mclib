...
public class DummyHuman1_9_4 extends EntityPlayer
{
    ...
    public DummyHuman1_9_4(MinecraftServer minecraftserver, WorldServer worldserver, GameProfile gameprofile, PlayerInteractManager playerinteractmanager, Location loc)
    {
        ...
        this.updateTask = new BukkitRunnable() {
            ...
            public void run()
            {
                for (final UUID uuid : DummyHuman1_9_4.this.trackedPlayers)
                {
    ...
    public void untrack(Player player)
    {
        new BukkitRunnable() {
            ...
            public void run()
            {
                DummyHuman1_9_4.this.trackedPlayers.remove(player.getUniqueId());
                DummyHuman1_9_4.this.inRange.remove(player.getUniqueId());
            }
        }.runTaskLater((Plugin) McLibInterface.instance(), 1);
    }
    ...
    public void track(Player player)
    {
        new BukkitRunnable() {
            ...
            public void run()
            {
                DummyHuman1_9_4.this.trackedPlayers.add(player.getUniqueId());
                DummyHuman1_9_4.this.inRange.put(player.getUniqueId(), Boolean.FALSE);
            }
        }.runTaskLater((Plugin) McLibInterface.instance(), 1);
    }
