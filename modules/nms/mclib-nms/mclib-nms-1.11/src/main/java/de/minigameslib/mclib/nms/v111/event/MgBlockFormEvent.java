...
import de.minigameslib.mclib.api.event.McBlockFormEvent;
 ...
 * @author mepeisen
 */
public class MgBlockFormEvent extends AbstractMinigameEvent<BlockFormEvent, McBlockFormEvent> implements McBlockFormEvent
{
