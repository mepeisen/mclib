...
import de.minigameslib.mclib.api.event.McEntityDeathEvent;
 ...
 * @author mepeisen
 */
public class MgEntityDeathEvent extends AbstractMinigameEvent<EntityDeathEvent, McEntityDeathEvent> implements McEntityDeathEvent
{
