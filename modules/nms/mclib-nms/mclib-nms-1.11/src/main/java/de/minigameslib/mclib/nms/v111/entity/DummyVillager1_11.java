 ...
 *
 */
public class DummyVillager1_11 extends EntityVillager
{
     ...
     * @param world
     */
    public DummyVillager1_11(World world)
    {
        super(world);
    ...
    @Override
    public boolean a(EntityHuman human, EnumHand enumhand)
    {
        // do nothing (trades)
        return false;
    }
    ...
    protected static final class VillagerNPC extends CraftVillager
    {
         ...
         * @param handle
         */
        public VillagerNPC(DummyVillager1_11 handle)
        {
