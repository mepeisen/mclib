...
import net.minecraft.server.v1_11_R1.BlockStateEnum;
import net.minecraft.server.v1_11_R1.BlockStateList;
import net.minecraft.server.v1_11_R1.CreativeModeTab;
import net.minecraft.server.v1_11_R1.EntityPlayer;
import net.minecraft.server.v1_11_R1.IBlockData;
import net.minecraft.server.v1_11_R1.IBlockState;
import net.minecraft.server.v1_11_R1.INamable;
...
public class CustomBlock extends Block
{
    ...
    public CustomBlock() {
        ...
        y(this.blockStateList.getBlockData().set(VARIANT, EnumCustomVariant.VARIANT_0));
        a(CreativeModeTab.b);
    ...
    public void postPlace(World world, BlockPosition blockposition, IBlockData iblockdata,
            net.minecraft.server.v1_11_R1.EntityLiving entityliving, net.minecraft.server.v1_11_R1.ItemStack itemstack)
    {
        final NmsInventoryHandlerInterface handler = this.inventoryHandler.get(this.toLegacyData(iblockdata));
        if (handler != null)
        {
    ...
    public boolean interact(World paramWorld, BlockPosition paramBlockPosition, IBlockData paramIBlockData,
            net.minecraft.server.v1_11_R1.EntityHuman paramEntityHuman, net.minecraft.server.v1_11_R1.EnumHand paramEnumHand, net.minecraft.server.v1_11_R1.EnumDirection paramEnumDirection, float paramFloat1,
     ...
     * @return block face
     */
    private BlockFace toBlockFace(net.minecraft.server.v1_11_R1.EnumDirection paramEnumDirection)
    {
    ...
    @Override
    public net.minecraft.server.v1_11_R1.Item getDropType(IBlockData iblockdata, Random random, int i) {
        return this.dropRule == null ? super.getDropType(iblockdata, random, i) : net.minecraft.server.v1_11_R1.Item.getById(this.dropRule.getDropType(this.toLegacyData(iblockdata), random, i));
    }
    ...
    @Override
    public int getExpDrop(net.minecraft.server.v1_11_R1.World world, IBlockData data, int i) {
