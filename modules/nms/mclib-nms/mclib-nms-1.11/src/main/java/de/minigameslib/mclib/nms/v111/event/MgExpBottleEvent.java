...
import de.minigameslib.mclib.api.event.McExpBottleEvent;
 ...
 * @author mepeisen
 */
public class MgExpBottleEvent extends AbstractMinigameEvent<ExpBottleEvent, McExpBottleEvent> implements McExpBottleEvent
{
