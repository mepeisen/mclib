...
import de.minigameslib.mclib.api.event.McBlockBurnEvent;
 ...
 * @author mepeisen
 */
public class MgBlockBurnEvent extends AbstractMinigameEvent<BlockBurnEvent, McBlockBurnEvent> implements McBlockBurnEvent
{
