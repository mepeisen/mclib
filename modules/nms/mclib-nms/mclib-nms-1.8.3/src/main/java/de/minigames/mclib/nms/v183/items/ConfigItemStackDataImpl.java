...
public class ConfigItemStackDataImpl extends AnnotatedDataFragment implements ConfigItemStackData
{
    ...
    {
        final net.minecraft.server.v1_8_R2.ItemStack nms = CraftItemStack.asNMSCopy(stack);
    ...
    {
        final net.minecraft.server.v1_8_R2.ItemStack stack = new net.minecraft.server.v1_8_R2.ItemStack(
                Item.d(this.mcid),
                this.amount,
                this.damage);
