...
import de.minigameslib.mclib.api.event.McVehicleDamageEvent;
 ...
 * @author mepeisen
 */
public class MgVehicleDamageEvent extends AbstractMinigameEvent<VehicleDamageEvent, McVehicleDamageEvent> implements McVehicleDamageEvent
{
     ...
     * @return passanger
     */
    private static McPlayerInterface passenger(VehicleDamageEvent event)
    {
     ...
     * @return passanger
     */
    private static ZoneInterface location(VehicleDamageEvent event)
    {
        final Entity passenger = event.getVehicle().getPassenger();
