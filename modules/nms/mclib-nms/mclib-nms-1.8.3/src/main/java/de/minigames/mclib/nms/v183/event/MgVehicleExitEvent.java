...
import de.minigameslib.mclib.api.event.McVehicleExitEvent;
...
public class MgVehicleExitEvent extends AbstractMinigameEvent<VehicleExitEvent, McVehicleExitEvent> implements McVehicleExitEvent
{
    ...
    {
        super(event, (event.getExited() instanceof Player) ? ObjectServiceInterface.instance().getPlayer((Player) event.getExited()) : null, event.getVehicle().getLocation());
    }
