...
package de.minigames.mclib.nms.v183.blocks;
...
import net.minecraft.server.v1_8_R2.BlockStateEnum;
import net.minecraft.server.v1_8_R2.BlockStateList;
import net.minecraft.server.v1_8_R2.CreativeModeTab;
import net.minecraft.server.v1_8_R2.EntityPlayer;
import net.minecraft.server.v1_8_R2.IBlockData;
import net.minecraft.server.v1_8_R2.IBlockState;
import net.minecraft.server.v1_8_R2.INamable;
...
public class CustomBlock extends Block
{
    ...
    public void postPlace(World world, BlockPosition blockposition, IBlockData iblockdata,
        net.minecraft.server.v1_8_R2.EntityLiving entityliving, net.minecraft.server.v1_8_R2.ItemStack itemstack)
    {
        final NmsInventoryHandlerInterface handler = this.inventoryHandler.get(this.toLegacyData(iblockdata));
        if (handler != null)
        {
    ...
    public boolean interact(World paramWorld, BlockPosition paramBlockPosition, IBlockData paramIBlockData,
        net.minecraft.server.v1_8_R2.EntityHuman paramEntityHuman, net.minecraft.server.v1_8_R2.EnumDirection paramEnumDirection, float paramFloat1,
     ...
     * @return block face
     */
    private BlockFace toBlockFace(net.minecraft.server.v1_8_R2.EnumDirection paramEnumDirection)
    {
    ...
    @Override
    public net.minecraft.server.v1_8_R2.Item getDropType(IBlockData iblockdata, Random random, int i)
    {
        return this.dropRule == null ? super.getDropType(iblockdata, random, i) : net.minecraft.server.v1_8_R2.Item.getById(this.dropRule.getDropType(this.toLegacyData(iblockdata), random, i));
    }
    ...
    @Override
    public int getExpDrop(net.minecraft.server.v1_8_R2.World world, IBlockData data, int i)
    {
