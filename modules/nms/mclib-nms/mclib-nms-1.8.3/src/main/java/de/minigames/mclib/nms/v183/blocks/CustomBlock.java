...
public class CustomBlock extends Block
{
    ...
    @Override
    public net.minecraft.server.v1_8_R2.Item getDropType(IBlockData iblockdata, Random random, int fortune)
    {
        return this.dropRule == null
            ? super.getDropType(iblockdata, random, fortune)
                : net.minecraft.server.v1_8_R2.Item.getById(this.dropRule.getDropType(this.toLegacyData(iblockdata), random, fortune));
    }
    ...
    @Override
    public int getExpDrop(net.minecraft.server.v1_8_R2.World world, IBlockData data, int enchantmentLevel)
    {
