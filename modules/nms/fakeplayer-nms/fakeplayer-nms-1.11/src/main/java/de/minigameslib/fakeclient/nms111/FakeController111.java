...
import net.minecraft.server.v1_11_R1.EnumMainHand;
...
import net.minecraft.server.v1_11_R1.PacketPlayInBlockDig.EnumPlayerDigType;
...
import net.minecraft.server.v1_11_R1.PacketPlayInEntityAction.EnumPlayerAction;
...
/**
 * Implementation of fake controller for 1.11
 * 
 * @author mepeisen
 */
public class FakeController111 implements IFakeController
{
     ...
     *            players name.
     */
    public FakeController111(IFakeClient client, String name)
    {
        this.client = client;
        this.name = name;
     ...
     * @return converted
     */
    private net.minecraft.server.v1_11_R1.ItemStack convert(ItemStack value)
    {
        final net.minecraft.server.v1_11_R1.ItemStack result = value.getTypeId() == 0 ? null : CraftItemStack.asNMSCopy(value);
        return result;
    }
