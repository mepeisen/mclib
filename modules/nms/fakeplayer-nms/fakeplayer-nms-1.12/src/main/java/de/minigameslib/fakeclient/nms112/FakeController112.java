...
package de.minigameslib.fakeclient.nms112;
...
/**
 * Implementation of fake controller for 1.12
 * 
 * @author mepeisen
 */
public class FakeController112 implements IFakeController
{
     ...
     *            players name.
     */
    public FakeController112(IFakeClient client, String name)
    {
        this.client = client;
        this.name = name;
     ...
     * @return converted
     */
    private net.minecraft.server.v1_12_R1.ItemStack convert(ItemStack value)
    {
        final net.minecraft.server.v1_12_R1.ItemStack result = value.getTypeId() == 0 ? null : CraftItemStack.asNMSCopy(value);
        return result;
    }
