...
import de.minigameslib.mclib.snakeyaml.DumperOptions.ScalarStyle;
...
public abstract class BaseRepresenter {
    ...
    protected Node representScalar(Tag tag, String value, Character style2) {
        Character style = style2;
        if (style == null) {
