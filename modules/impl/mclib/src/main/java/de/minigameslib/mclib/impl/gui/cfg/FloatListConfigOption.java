...
/**
 * Config option to edit float list variables.
 * 
 * @author mepeisen
 *
 */
public class FloatListConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public FloatListConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
    ...
    {
        final float[] prim = this.calculate(contextProvider, this.getValue()::getFloatList);
        final Float[] arr = new Float[prim.length];
