...
/**
 * Config option to edit player variables.
 * 
 * @author mepeisen
 *
 */
public class PlayerConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public PlayerConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
    ...
    {
        final ItemStack stack = ItemServiceInterface.instance().createItem(CommonItems.App_People);
