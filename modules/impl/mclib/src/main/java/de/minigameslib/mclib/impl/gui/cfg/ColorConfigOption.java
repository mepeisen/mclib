...
/**
 * Config option to edit color variables.
 * 
 * @author mepeisen
 *
 */
public class ColorConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public ColorConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
