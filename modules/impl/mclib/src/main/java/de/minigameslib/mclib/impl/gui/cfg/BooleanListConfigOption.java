...
/**
 * Config option to edit boolean lists variables.
 * 
 * @author mepeisen
 *
 */
public class BooleanListConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public BooleanListConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
    ...
    {
        final ItemStack stack = ItemServiceInterface.instance().createItem(CommonItems.App_Yes);
    ...
    {
        final boolean[] prim = this.calculate(contextProvider, this.getValue()::getBooleanList);
        final Boolean[] arr = new Boolean[prim.length];
