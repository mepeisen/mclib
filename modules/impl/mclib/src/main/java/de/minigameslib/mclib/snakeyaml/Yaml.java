...
import de.minigameslib.mclib.snakeyaml.serializer.Serializer;
...
public class Yaml {
    ...
    /** flag to control comment parsing. */
    ...
    private Object loadFromReader(StreamReader sreader, Class<?> type) {
        Composer composer = new Composer(new ParserImpl(sreader, this.skipComments), resolver);
    ...
    public Iterable<Object> loadAll(Reader yaml) {
        Composer composer = new Composer(new ParserImpl(new StreamReader(yaml), this.skipComments), resolver);
        constructor.setComposer(composer);
    ...
    public Iterable<Node> composeAll(Reader yaml) {
        final Composer composer = new Composer(new ParserImpl(new StreamReader(yaml), this.skipComments), resolver);
        constructor.setComposer(composer);
    ...
    public Iterable<Event> parse(Reader yaml) {
        final Parser parser = new ParserImpl(new StreamReader(yaml), this.skipComments);
	...
	/**
	 * Returns the skip comments flag.
	 * @return true if comments will be silently dropped while reading.
	 */
	...
	/**
	 * Sets the skip comments flag; defaults to true if not set.
	 * @param skipComments true to silently drop comments while reading.
	 */
