...
/**
 * Config option to edit double list variables.
 * 
 * @author mepeisen
 *
 */
public class DoubleListConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public DoubleListConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
    ...
    {
        final double[] prim = this.calculate(contextProvider, this.getValue()::getDoubleList);
        final Double[] arr = new Double[prim.length];
