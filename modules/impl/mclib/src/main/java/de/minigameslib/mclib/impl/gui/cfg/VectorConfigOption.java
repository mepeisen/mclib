...
/**
 * Config option to edit vector variables.
 * 
 * @author mepeisen
 *
 */
public class VectorConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public VectorConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
