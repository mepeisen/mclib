...
import de.minigameslib.mclib.snakeyaml.events.NodeEvent;
...
public class ParserImpl implements Parser {
    ...
    public ParserImpl(StreamReader reader, boolean skipComments) {
        this(new ScannerImpl(reader, skipComments));
    }
    ...
    private Event parseNode(boolean block, boolean indentlessSequence) {
        ...
        while (scanner.checkToken(Token.ID.Comment)) {
            CommentToken token = (CommentToken) scanner.getToken();
            comments.add(token.getValue());
        }
