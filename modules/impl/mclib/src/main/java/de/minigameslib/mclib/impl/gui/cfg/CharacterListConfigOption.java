...
/**
 * Config option to edit character list variables.
 * 
 * @author mepeisen
 *
 */
public class CharacterListConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public CharacterListConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
    ...
    public ClickGuiItem getItem(Runnable onChange, McRunnable contextProvider) throws McException
    {
        ...
        return new ClickGuiItem(stack, AbstractConfigOption.Messages.ConfigNameWithStringValue, (p, s, g) -> this.select(p, s, g, onChange, contextProvider), this.getValue().path(), new String(str));
    }
