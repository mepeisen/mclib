...
/**
 * Config option to edit double variables.
 * 
 * @author mepeisen
 *
 */
public class DoubleConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public DoubleConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
