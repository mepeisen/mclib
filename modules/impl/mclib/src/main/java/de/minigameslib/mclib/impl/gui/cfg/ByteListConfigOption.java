...
/**
 * Config option to edit byte list variables.
 * 
 * @author mepeisen
 *
 */
public class ByteListConfigOption extends AbstractConfigOption
{
    ...
    {
        final byte[] prim = this.calculate(contextProvider, this.getValue()::getByteList);
        final Byte[] arr = new Byte[prim.length];
