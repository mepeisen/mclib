...
/**
 * Implementation of sign id.
 * 
 * @author mepeisen
 *
 */
public class SignId implements SignIdInterface
{
     ...
     *            unique id
     */
    public SignId(String pluginName, String type, UUID uuid)
    {
    ...
    public boolean test(DataSection section)
    {
        return section.isString("plugin") //$NON-NLS-1$
            ...
            && idUuid(section.getString("uuid")); //$NON-NLS-1$
    }
     ...
     */
    private boolean idUuid(String str)
    {
        try
        {
            if (str == null)
