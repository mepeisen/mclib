...
/**
 * Config option to edit enum variables.
 * 
 * @author mepeisen
 *
 */
public class JavaEnumConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public JavaEnumConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
    ...
    private void select(McPlayerInterface player, GuiSessionInterface session, ClickGuiInterface guiInterface, Runnable onChange, McRunnable contextProvider) throws McException
    {
        ...
        final Enum<?> value = this.calculate(contextProvider, () -> this.getValue().getJavaEnum(clazz));
