...
/**
 * Config option to edit character variables.
 * 
 * @author mepeisen
 *
 */
public class CharacterConfigOption extends AbstractConfigOption
{
     ...
     *            value to be edited.
     */
    public CharacterConfigOption(ConfigurationValueInterface value)
    {
        super(value);
    }
