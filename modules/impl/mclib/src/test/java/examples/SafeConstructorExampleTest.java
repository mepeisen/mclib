...
import de.minigameslib.mclib.snakeyaml.constructor.SafeConstructor;
...
public class SafeConstructorExampleTest extends TestCase {
    ...
    public void testSafeConstruct() {
        String doc = "- 5\n- !de.minigameslib.mclib.snakeyaml.constructor.Person\n  firstName: Andrey\n  age: 99\n- true";
        Yaml yaml = new Yaml(new SafeConstructor());
        try {
            yaml.load(doc);
            ...
            assertEquals(
                    "could not determine a constructor for the tag !de.minigameslib.mclib.snakeyaml.constructor.Person\n"
                            + " in 'string', line 2, column 3:\n"
                            + "    - !de.minigameslib.mclib.snakeyaml ... \n" + "      ^\n",
                    e.getMessage());
        }
    }
}
