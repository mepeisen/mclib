...
public class CollectionWithBeanYamlTest extends TestCase {
    ...
    public void testYamlMap() {
        ...
        assertEquals(
                "gold1: !!de.minigameslib.mclib.snakeyaml.CollectionWithBeanYamlTest$Bean {a: ''}\ngold2: !!de.minigameslib.mclib.snakeyaml.CollectionWithBeanYamlTest$Bean {a: ''}\n",
                output);
    ...
    public void testYamlList() {
        ...
        String output = yaml.dump(data);
        assertEquals(
                "- !!de.minigameslib.mclib.snakeyaml.CollectionWithBeanYamlTest$Bean {a: '1'}\n- !!de.minigameslib.mclib.snakeyaml.CollectionWithBeanYamlTest$Bean {a: '2'}\n",
                output);
        Object o = yaml.load(output);
