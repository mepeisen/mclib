...
public class ConstructEmptyBeanTest extends TestCase {
    ...
    public void testEmptyBean() {
        ...
        EmptyBean bean = (EmptyBean) yaml
                .load("!!de.minigameslib.mclib.snakeyaml.javabeans.ConstructEmptyBeanTest$EmptyBean {}");
        assertNotNull(bean);
    ...
    public void testEmptyBean1() {
        ...
        EmptyBean bean = beanLoader.loadAs(
                "!!de.minigameslib.mclib.snakeyaml.javabeans.ConstructEmptyBeanTest$EmptyBean {}",
                EmptyBean.class);
        assertNotNull(bean);
        assertNull(bean.getFirstName());
        assertEquals(5, bean.getHatSize());
