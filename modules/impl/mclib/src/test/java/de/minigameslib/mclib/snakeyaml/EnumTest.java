 ...
 */
package de.minigameslib.mclib.snakeyaml;
...
public class EnumTest extends TestCase {
    ...
    public void testDumpEnum() {
        ...
        assertEquals("!!de.minigameslib.mclib.snakeyaml.Suit 'CLUBS'\n", output);
    }

    public void testDumpOverriddenToString() {
        Yaml yaml = new Yaml();
        String output = yaml.dump(DumperOptions.FlowStyle.BLOCK);
        assertEquals("!!de.minigameslib.mclib.snakeyaml.DumperOptions$FlowStyle 'BLOCK'\n", output);
    }
    ...
    public void testDumpEnumArray() {
        ...
        assertEquals(
                "- !!de.minigameslib.mclib.snakeyaml.Suit 'CLUBS'\n- !!de.minigameslib.mclib.snakeyaml.Suit 'DIAMONDS'\n- !!de.minigameslib.mclib.snakeyaml.Suit 'HEARTS'\n- !!de.minigameslib.mclib.snakeyaml.Suit 'SPADES'\n",
                output);
    }
    ...
    public void testDumpEnumMap() {
        ...
        assertEquals(
                "c: !!de.minigameslib.mclib.snakeyaml.Suit 'CLUBS'\nd: !!de.minigameslib.mclib.snakeyaml.Suit 'DIAMONDS'\n",
                output);
    }
    ...
    public void testDumpEnumMap2() {
        ...
        String output = yaml.dump(map);
        assertEquals(
                "!!de.minigameslib.mclib.snakeyaml.Suit 'CLUBS': 0\n!!de.minigameslib.mclib.snakeyaml.Suit 'DIAMONDS': 123\n",
                output);
    }
    ...
    public void testDumpEnumBean() {
        ...
        assertEquals(
                "!!de.minigameslib.mclib.snakeyaml.EnumBean\nid: 17\nmap:\n  CLUBS: 1\n  DIAMONDS: 2\nsuit: SPADES\n",
                output);
    }
    ...
    public void testLoadEnum() {
        Yaml yaml = new Yaml();
        Suit suit = (Suit) yaml.load("!!de.minigameslib.mclib.snakeyaml.Suit 'CLUBS'\n");
    ...
    public void testLoadOverridenToString() {
        ...
        assertEquals(DumperOptions.FlowStyle.BLOCK,
                yaml.load("!!de.minigameslib.mclib.snakeyaml.DumperOptions$FlowStyle 'BLOCK'\n"));
    }
    ...
    public void testLoadEnumList() {
        ...
        List<Suit> list = (List<Suit>) yaml
                .load("- !!de.minigameslib.mclib.snakeyaml.Suit 'CLUBS'\n- !!de.minigameslib.mclib.snakeyaml.Suit 'DIAMONDS'\n- !!de.minigameslib.mclib.snakeyaml.Suit 'HEARTS'\n- !!de.minigameslib.mclib.snakeyaml.Suit 'SPADES'");
    ...
    public void testLoadEnumMap() {
        ...
        Map<Integer, Suit> map = (Map<Integer, Suit>) yaml
                .load("1: !!de.minigameslib.mclib.snakeyaml.Suit 'HEARTS'\n2: !!de.minigameslib.mclib.snakeyaml.Suit 'DIAMONDS'");
    ...
    public void testLoadEnumBean() {
        ...
        EnumBean bean = (EnumBean) yaml
                .load("!!de.minigameslib.mclib.snakeyaml.EnumBean\nid: 174\nmap:\n  !!de.minigameslib.mclib.snakeyaml.Suit 'CLUBS': 1\n  !!de.minigameslib.mclib.snakeyaml.Suit 'DIAMONDS': 2\nsuit: CLUBS");
    ...
    public void testLoadWrongEnum() {
        Yaml yaml = new Yaml();
        try {
            yaml.load("1: !!de.minigameslib.mclib.snakeyaml.Suit 'HEARTS'\n2: !!de.minigameslib.mclib.snakeyaml.Suit 'KOSYR'");
