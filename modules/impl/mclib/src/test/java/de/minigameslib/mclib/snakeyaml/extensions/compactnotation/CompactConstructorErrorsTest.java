 ...
 */
package de.minigameslib.mclib.snakeyaml.extensions.compactnotation;
...
import de.minigameslib.mclib.snakeyaml.constructor.BaseConstructor;
...
public class CompactConstructorErrorsTest extends TestCase {
    ...
    private Object load(String fileName) {
        CompactConstructor compact = new PackageCompactConstructor(
                "de.minigameslib.mclib.snakeyaml.extensions.compactnotation");
        Yaml yaml = new Yaml(compact);
    ...
    public void test2() {
        check("error2.yaml",
                ...
                "java.lang.NoSuchMethodException: de.minigameslib.mclib.snakeyaml.extensions.compactnotation.Table.<init>(java.lang.String)");
    }

    public void test3() {
        check("error3.yaml",
                "In-line parameters can only be Strings.",
                "de.minigameslib.mclib.snakeyaml.error.YAMLException: Cannot set property='size' with value='17' (class java.lang.String) in Row id=id111");
    }
    ...
    public void test6() {
        check("error6.yaml",
                "Invalid property.",
                "de.minigameslib.mclib.snakeyaml.error.YAMLException: Unable to find property 'foo' on class: de.minigameslib.mclib.snakeyaml.extensions.compactnotation.Table");
    }

    public void test7() {
        check("error7.yaml",
                "Invalid property.",
                "Unable to find property 'foo' on class: de.minigameslib.mclib.snakeyaml.extensions.compactnotation.Table",
                false);
    }
    ...
    public void test8() {
        check("error8.yaml",
                "No list property",
                "de.minigameslib.mclib.snakeyaml.error.YAMLException: No list property found in class de.minigameslib.mclib.snakeyaml.extensions.compactnotation.Row");
    }

    public void test9() {
        check("error9.yaml",
                "Many list properties found",
                "de.minigameslib.mclib.snakeyaml.error.YAMLException: Many list properties found in class de.minigameslib.mclib.snakeyaml.extensions.compactnotation.ManyListsTable; Please override getSequencePropertyName() to specify which property to use.");
    }
}
