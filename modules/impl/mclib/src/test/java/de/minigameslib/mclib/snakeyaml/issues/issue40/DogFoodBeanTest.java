 ...
 */
package de.minigameslib.mclib.snakeyaml.issues.issue40;
...
public class DogFoodBeanTest extends TestCase {
    ...
    public void testOwnBigDecimal() {
        ...
        assertEquals("!!de.minigameslib.mclib.snakeyaml.issues.issue40.DogFoodBean {decimal: !!float '5'}\n",
                text);
    ...
    public void testBigDecimalPrecision() {
        ...
        String text = yaml.dump(input);
        // System.out.println(text);
        assertEquals("!!de.minigameslib.mclib.snakeyaml.issues.issue40.DogFoodBean {decimal: 5.123}\n", text);
        DogFoodBean output = (DogFoodBean) yaml.load(text);
