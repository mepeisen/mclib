 ...
 */
package de.minigameslib.mclib.snakeyaml.issues.issue100;
...
public class MergeJavaBeanTest extends TestCase {
    ...
    public void testNoMerge() {
        String input = "- &id001 !!de.minigameslib.mclib.snakeyaml.issues.issue100.Data {age: 11, id: id123}\n- *id001";
    ...
    public void testMergeAndDeviateOverride() {
        String input = "- &id001 !!de.minigameslib.mclib.snakeyaml.issues.issue100.Data {age: 11, id: id123}\n- &id002 !!de.minigameslib.mclib.snakeyaml.issues.issue100.Data {age: 37}\n- <<: [ *id002, *id001 ]";
        // System.out.println(input);
        Yaml yaml = new Yaml();
        List<Data> list = (List<Data>) yaml.load(input);
    ...
    public void testMergeMapToJavaBean() {
        String input = "- &id001 { age: 11, id: id123 }\n- !!de.minigameslib.mclib.snakeyaml.issues.issue100.Data\n  <<: *id001\n  id: id456";
        // System.out.println(input);
