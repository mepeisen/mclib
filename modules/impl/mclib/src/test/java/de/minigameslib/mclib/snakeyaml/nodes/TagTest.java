...
public class TagTest extends TestCase {
    ...
    public void testCreate() {
        ...
        assertEquals(Tag.PREFIX + "de.minigameslib.mclib.snakeyaml.nodes.TagTest", tag.getValue());
    }
    ...
    public void testGetClassName() {
        Tag tag = new Tag(Tag.PREFIX + "de.minigameslib.mclib.snakeyaml.nodes.TagTest");
        assertEquals("de.minigameslib.mclib.snakeyaml.nodes.TagTest", tag.getClassName());
    }
    ...
    public void testLength() {
        String t = Tag.PREFIX + "de.minigameslib.mclib.snakeyaml.nodes.TagTest";
        Tag tag = new Tag(t);
