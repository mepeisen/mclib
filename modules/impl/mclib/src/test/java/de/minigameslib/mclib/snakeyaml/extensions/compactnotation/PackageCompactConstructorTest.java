...
public class PackageCompactConstructorTest extends TestCase {
    ...
    public void testGetClassForName() throws ClassNotFoundException {
        ...
        assertEquals(Table.class, check("de.minigameslib.mclib.snakeyaml.extensions.compactnotation.Table"));
    ...
    private Class<?> check(String name) throws ClassNotFoundException {
        return new PackageCompactConstructor("de.minigameslib.mclib.snakeyaml.extensions.compactnotation")
