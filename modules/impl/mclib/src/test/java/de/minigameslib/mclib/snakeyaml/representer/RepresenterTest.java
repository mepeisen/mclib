...
public class RepresenterTest extends TestCase {
    ...
    public void testRepresenter() {
        ...
        Yaml yaml = new Yaml();
        assertEquals(
                "!!de.minigameslib.mclib.snakeyaml.representer.RepresenterTest$MyBean {name: Gnome,\n  primitive: true}\n",
                yaml.dump(bean));
    }
    ...
    public void testRepresenterNoConstructorAvailable() {
        ...
        assertEquals("!!de.minigameslib.mclib.snakeyaml.representer.RepresenterTest$MyBean2 {valid: true}\n",
                yaml.dump(bean));
    }
    ...
    public void testRepresenterGetterWithException() {
        ...
        assertEquals(
                ...
                "!!de.minigameslib.mclib.snakeyaml.representer.RepresenterTest$MyBean3 {boolProperty: true,\n  name: Gnome}\n",
                str);
    }
    ...
    public void testRepresenterEmptyBean() {
        ...
        try {
            ...
            assertEquals(
                    "No JavaBean properties found in de.minigameslib.mclib.snakeyaml.representer.RepresenterTest$EmptyBean",
                    e.getMessage());
        }
    }
