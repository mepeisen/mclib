...
public class NopropTest extends TestCase {
    ...
    public void testOK01() {
        String yaml = "--- !!de.minigameslib.mclib.snakeyaml.issues.issue9.BeanHolder\nbean : !!de.minigameslib.mclib.snakeyaml.issues.issue9.Bean1\n  intVal : 11\n  strVal : HALLO_1 ";
    ...
    public void testOK02() {
        String yaml = "--- !!de.minigameslib.mclib.snakeyaml.issues.issue9.BeanHolder\nbean : !!de.minigameslib.mclib.snakeyaml.issues.issue9.Bean2\n  intVal : 22\n  strVal : HALLO_2 ";
        Iterator<Object> docs = new Yaml().loadAll(yaml).iterator();
        assertTrue(docs.hasNext());
        BeanHolder beanHolder = (BeanHolder) docs.next();
    ...
    public void testNonBean() {
        String yaml = "--- !!de.minigameslib.mclib.snakeyaml.issues.issue9.BeanHolder\nbean : !!de.minigameslib.mclib.snakeyaml.issues.issue9.Bean1 123";
        Iterator<Object> docs = new Yaml().loadAll(yaml).iterator();
        assertTrue(docs.hasNext());
        BeanHolder beanHolder = (BeanHolder) docs.next();
        assertEquals("BEAN_1", beanHolder.getBean().getStrVal());
