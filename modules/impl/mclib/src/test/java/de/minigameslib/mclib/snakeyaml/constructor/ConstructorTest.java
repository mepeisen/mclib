...
public class ConstructorTest extends TestCase {
    ...
    public void testGetBeanAssumeClass() {
        String data = "--- !!de.minigameslib.mclib.snakeyaml.constructor.Person\nfirstName: Andrey\nage: 99";
    ...
    public void testGetConstructorBean() {
        String data = "--- !!de.minigameslib.mclib.snakeyaml.constructor.Person [ Andrey, Somov, 99 ]";
        Object obj = construct(data);
        assertNotNull(obj);
    ...
    public void testGetConstructorFromScalar() {
        String data = "--- !!de.minigameslib.mclib.snakeyaml.constructor.Person 'Somov'";
        Object obj = construct(data);
        assertNotNull(obj);
        assertTrue(obj.getClass().toString(), obj instanceof Person);
        Person person = (Person) obj;
    ...
    public void testJavaBeanLoad() {
        ...
        assertEquals(
                expected,
                construct("--- !!de.minigameslib.mclib.snakeyaml.constructor.TestBean\nname: Ola Bini\nage: 24\nborn: 1982-05-03\n"));
    }
        ...
        try {
            ...
            assertEquals(
                    "Cannot create property=wrongName for JavaBean=#<org.jvyaml.TestBean name=\"null\" age=0 born=\"null\">\n"
                            ...
                            + "        ^\n"
                            + "Unable to find property 'wrongName' on class: de.minigameslib.mclib.snakeyaml.constructor.TestBean\n"
