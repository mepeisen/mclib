 ...
 */
package de.minigameslib.mclib.snakeyaml.representer;
...
public class RepresentFieldTest extends TestCase {
    ...
    public void testRepresent1() {
        ...
        assertEquals(
                "!!de.minigameslib.mclib.snakeyaml.representer.WrongJavaBean {publicField: Michael Jackson}\n",
                output);
    }
    ...
    public void testWrongNotPublicField() {
        ...
        bean.packageField = "Value";// the field is present
        try {
            yaml.load("!!de.minigameslib.mclib.snakeyaml.representer.WrongJavaBean {packageField: Gnome}\n");
            ...
            assertEquals(
                    "Unable to find property 'packageField' on class: de.minigameslib.mclib.snakeyaml.representer.WrongJavaBean",
    ...
    public void testStaticField() {
        ...
        try {
            yaml.load("!!de.minigameslib.mclib.snakeyaml.representer.WrongJavaBean {staticField: Gnome}\n");
            ...
            assertEquals(
                    "Unable to find property 'staticField' on class: de.minigameslib.mclib.snakeyaml.representer.WrongJavaBean",
                    e.getCause().getMessage());
        }
    }
}
