...
public class MockDateBeanConstructorTest extends TestCase {
    ...
    public void testConstructor() {
        String className = "!!de.minigameslib.mclib.snakeyaml.constructor.MockDateBeanConstructorTest$DateBean {number: 24, date: 2009-07-24}";
        Yaml yaml = new Yaml();
        try {
            yaml.load(className);
            ...
            assertEquals(
                    "Cannot construct: 'class de.minigameslib.mclib.snakeyaml.constructor.MockDateBeanConstructorTest$MockDate'",
