 ...
 */
package de.minigameslib.mclib.snakeyaml.issues.issue47;
...
public class ReadOnlyPropertiesTest extends TestCase {
    ...
    public void testBean2() {
        ...
        try {
            ...
            assertTrue(
                    message,
                    message.contains("Unable to find property 'id' on class: de.minigameslib.mclib.snakeyaml.issues.issue47.IncompleteBean"));
        }
    }
}
