 ...
 */
package de.minigameslib.mclib.snakeyaml.issues.issue124;
...
public class DumpTest extends TestCase {
    ...
    public void testDumperOptionsSideEffect() {
        ...
        assertEquals("!!de.minigameslib.mclib.snakeyaml.issues.issue124.Bean124\na: aaa\nnumbers: [1, 2, 3]\n",
                output0);
    ...
    public void testDumperNullTag() {
        ...
        assertEquals(
                "!!de.minigameslib.mclib.snakeyaml.issues.issue124.Bean124\na: aaa\nnumbers:\n- 1\n- 2\n- 3\n",
                output1);
    }
}