...
public class FilterClassesConstructorTest extends TestCase {
    ...
    public void testGetClassForName() {
        ...
        String input = "!!de.minigameslib.mclib.snakeyaml.constructor.FilterClassesConstructorTest$FilteredBean {name: Andrey, number: 543}";
        try {
            yaml.load(input);
    ...
    class FilterConstructor extends Constructor {
        ...
        protected Class<?> getClassForName(String name) throws ClassNotFoundException {
            if (filter && name.startsWith("de.minigameslib.mclib.snakeyaml")) {
