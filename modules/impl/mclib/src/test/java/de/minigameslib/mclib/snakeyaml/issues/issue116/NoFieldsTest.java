 ...
 */
package de.minigameslib.mclib.snakeyaml.issues.issue116;
...
public class NoFieldsTest extends TestCase {
    ...
    public void testEmptyClass() {
        ...
        assertEquals("!!de.minigameslib.mclib.snakeyaml.issues.issue116.Empty {}\n", result);
    ...
    public void testHiddenParameter() {
        ...
        try {
            ...
            assertEquals(e.getMessage(),
                    "No JavaBean properties found in de.minigameslib.mclib.snakeyaml.issues.issue116.Hidden");
        }
        Object hiddenParsed = yaml.load("!!de.minigameslib.mclib.snakeyaml.issues.issue116.Hidden {}\n");
    ...
    public void testSpecialHiddenParameter() {
        ...
        try {
            ...
            assertEquals(e.getMessage(),
                    "No JavaBean properties found in de.minigameslib.mclib.snakeyaml.issues.issue116.HiddenSpecial");
        }
        HiddenSpecial hs = (HiddenSpecial) yaml
                .load("!!de.minigameslib.mclib.snakeyaml.issues.issue116.HiddenSpecial foo\n");
