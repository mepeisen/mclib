...
public class NodeTupleTest extends TestCase {
    ...
    public void testToString() {
        ...
        assertEquals(
                "<NodeTuple keyNode=<de.minigameslib.mclib.snakeyaml.nodes.ScalarNode (tag=tag:yaml.org,2002:str, value=key1)>; valueNode=<de.minigameslib.mclib.snakeyaml.nodes.ScalarNode (tag=tag:yaml.org,2002:str, value=value1)>>",
                tuple.toString());
    }
