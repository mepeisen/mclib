 ...
 */
package de.minigameslib.mclib.snakeyaml.issues.issue8;
...
public class PrattleRepresenterTest extends TestCase {
    public void test() {
        ...
        String etalon = "!!de.minigameslib.mclib.snakeyaml.issues.issue8.Person {firstName: Alan, hatSize: 9,\n  lastName: Gutierrez}\n";
    ...
    public void test2beans() {
        ...
        String etalon2 = "!!de.minigameslib.mclib.snakeyaml.issues.issue8.PrattleRepresenterTest$Horse\nname: Tom\nowner: {firstName: Alan, hatSize: 9, lastName: Gutierrez}\n";
