 ...
 */
package de.minigameslib.mclib.snakeyaml.array;
...
import de.minigameslib.mclib.snakeyaml.constructor.ConstructorException;
import de.minigameslib.mclib.snakeyaml.error.YAMLException;
import junit.framework.TestCase;

public class PrimitiveArrayTest extends TestCase {

    private final String pkg = "!!de.minigameslib.mclib.snakeyaml.array";
    ...
    public static class ArrayLongArr {
        ...
        public int hashCode()
        {
            // only to disable an error check; not used
