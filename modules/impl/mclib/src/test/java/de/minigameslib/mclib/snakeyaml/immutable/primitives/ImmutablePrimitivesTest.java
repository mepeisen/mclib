...
public class ImmutablePrimitivesTest extends TestCase {
    ...
    public void testPrimitives() {
        ...
        assertEquals("!!" + bunch.getClass().getCanonicalName() + " [10, 40.0,\n  true]\n", dump);
    ...
    public void testPrimitivesLong() {
        Yaml yaml = new Yaml();
        String dump = "!!de.minigameslib.mclib.snakeyaml.immutable.primitives.BunchOfPrimitives [10000000000, 40.0, true]";
    ...
    public void testPrimitivesException() {
        Yaml yaml = new Yaml();
        String dump = "!!de.minigameslib.mclib.snakeyaml.immutable.primitives.BunchOfPrimitives [10, 40, true]";
        try {
            yaml.load(dump);
            fail();
            ...
            assertTrue(e
                    .getMessage()
                    .startsWith(
                            "Can't construct a java object for tag:yaml.org,2002:de.minigameslib.mclib.snakeyaml.immutable.primitives.BunchOfPrimitives; exception=No suitable constructor with 3 arguments found for class de.minigameslib.mclib.snakeyaml.immutable.primitives.BunchOfPrimitives"));
        }
    }
}
