 ...
 */
package de.minigameslib.mclib.snakeyaml.generics;
...
public class GenericArrayTypeTest extends TestCase {
    ...
    public void testClasses() throws IntrospectionException {
        ...
        String etalon = "!!de.minigameslib.mclib.snakeyaml.generics.GenericArrayTypeTest$GenericArray\n"
                + "home: [1, 2, 3]\n" + "name: Array3\n";
        ...
        if (GenericsBugDetector.isProperIntrospection()) {
            ...
            try {
                ...
                String message = "Cannot create property=home for JavaBean=de.minigameslib.mclib.snakeyaml.generics.GenericArrayTypeTest$GenericArray";
