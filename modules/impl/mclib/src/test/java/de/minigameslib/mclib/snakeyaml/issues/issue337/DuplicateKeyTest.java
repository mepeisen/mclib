 ...
 */
package de.minigameslib.mclib.snakeyaml.issues.issue337;
...
import de.minigameslib.mclib.snakeyaml.LoaderOptions;
...
public class DuplicateKeyTest {
    ...
    public void errorOnDuplicateKeys() {
        thrown.expect(de.minigameslib.mclib.snakeyaml.constructor.ConstructorException.class);
