...
public class TriangleBeanTest extends TestCase {
    ...
    public void testGetTriangle() {
        ...
        assertEquals(
                "name: Bean25\nshape: !!de.minigameslib.mclib.snakeyaml.javabeans.Triangle\n  name: Triangle25\n",
                output);
    ...
    public void testClassNotFound() {
        String output = "name: Bean25\nshape: !!de.minigameslib.mclib.snakeyaml.javabeans.Triangle777\n  name: Triangle25\n";
        Yaml beanLoader = new Yaml();
        try {
            ...
            assertTrue(
                    ...
                    e.getMessage().contains(
                            "Class not found: de.minigameslib.mclib.snakeyaml.javabeans.Triangle777"));
        }
    }
