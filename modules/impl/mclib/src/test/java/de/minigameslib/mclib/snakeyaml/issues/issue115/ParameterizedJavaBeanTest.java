 ...
 */
package de.minigameslib.mclib.snakeyaml.issues.issue115;
...
public class ParameterizedJavaBeanTest extends TestCase {
    ...
    public void testAsStandalone() {
        ...
        assertEquals("!!de.minigameslib.mclib.snakeyaml.issues.issue115.ParameterizedBean {k: 13, v: ID47}\n",
                result);
        // load
    ...
    public void testAsJavaBeanProperty() {
        ...
        assertEquals("!!de.minigameslib.mclib.snakeyaml.issues.issue115.IssueBean\nbean: {k: 432, v: Val432}\n",
                result);
        // load
