...
/**
 * Test case for {@link SendErrorData}.
 * 
 * @author mepeisen
 *
 */
public class SendErrorDataTest
{
    ...
    public void testMe()
    {
        final SendErrorData data = new SendErrorData();
        ...
        final SendErrorData data2 = section.getFragment(SendErrorData.class, "FOO"); //$NON-NLS-1$
