...
/**
 * Test case for {@link DisplayYesNoData}
 * 
 * @author mepeisen
 *
 */
public class DisplayYesNoDataTest
{
    ...
    public void testMe()
    {
        final DisplayYesNoData data = new DisplayYesNoData();
        ...
        final DisplayYesNoData data2 = section.getFragment(DisplayYesNoData.class, "FOO"); //$NON-NLS-1$
