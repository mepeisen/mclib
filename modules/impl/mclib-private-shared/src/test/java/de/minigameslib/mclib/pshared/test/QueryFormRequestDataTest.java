 ...
 *
 */
public class QueryFormRequestDataTest
{
    ...
    public void testMe()
    {
        final QueryFormRequestData data = new QueryFormRequestData();
        ...
        final QueryFormRequestData data2 = section.getFragment(QueryFormRequestData.class, "FOO"); //$NON-NLS-1$
