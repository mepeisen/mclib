 ...
 *
 */
public class DisplayInfoDataTest
{
    ...
    public void testMe()
    {
        final DisplayInfoData data = new DisplayInfoData();
        ...
        final DisplayInfoData data2 = section.getFragment(DisplayInfoData.class, "FOO"); //$NON-NLS-1$
