...
/**
 * Test case for {@link RemoveMarkerData}.
 * 
 * @author mepeisen
 *
 */
public class RemoveMarkerDataTest
{
    ...
    public void testMe()
    {
        ...
        final RemoveMarkerData data2 = section.getFragment(RemoveMarkerData.class, "FOO"); //$NON-NLS-1$
