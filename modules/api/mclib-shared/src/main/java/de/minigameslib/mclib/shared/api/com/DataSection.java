...
public interface DataSection
{
     ...
     * 
     * @param deep
     *            {@code true} to return the deep keys
     * @return keys of data
     */
     ...
     * 
     * @param deep
     *            {@code true} to return the deep values
     * @return data values.
     */
     ...
     *            name of the object
     * @param defaultValue
     *            the default value to return if object was not found
     ...
     * 
     * @param key
     *            name of the data section to be set
     * @param newValue
     *            new value
     */
     ...
     *            name of the section to be created
     * @param values
     *            default values to set into the new section
     * @return data section.
     */
     ...
     *            name of the string
     * @param defaultValue
     *            default value to return if string was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the string to be checked
     ...
     *            name of the int
     * @param defaultValue
     *            default value to return if int was not found
     * @return value
     */
     ...
     *            name of the byte
     * @param defaultValue
     *            default value to return if byte was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the byte to be checked
     ...
     *            name of the short
     * @param defaultValue
     *            default value to return if short was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the short to be checked
     ...
     *            name of the char
     * @param defaultValue
     *            default value to return if char was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the char to be checked
     ...
     *            name of the object
     * @param defaultValue
     *            default value to return if object was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the object to be tested
     ...
     *            name of the boolean
     * @param defaultValue
     *            default value to return if boolean was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the boolean to be checked
     ...
     *            name of the double
     * @param defaultValue
     *            default value to return if double was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the double to be checked
     ...
     *            name of the float
     * @param defaultValue
     *            default value to return if float was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the float to be checked.
     ...
     *            name of the long
     * @param defaultValue
     *            default value to return if long was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the long to be checked
     ...
     *            name of the list
     * @param defaultValue
     *            default value to return if list was not found
     * @return value
     */
     ...
     *            name of the vector
     * @param defaultValue
     *            default value to return if vector was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the vector to be tested
     ...
     *            name of the block location
     * @param defaultValue
     *            default value to return if block location was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the block location to be checked
     ...
     *            name of the location
     * @param defaultValue
     *            default value to return if location was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the location to be tested
     ...
     * 
     * @param key
     *            name of the server block location
     * @return value
     */
     ...
     *            name of the server block location
     * @param defaultValue
     *            default value to return if server block location was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the server block location to be tested
     * @return true if key has a block location value
     */
     ...
     *            name of the server location
     * @param defaultValue
     *            default value to return if server location was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the server location to be tested
     * @return true if key has a location value
     */
     ...
     *            name of the server
     * @param defaultValue
     *            default value to return if server was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the server to be tested
     ...
     *            name of the player object
     * @param defaultValue
     *            default value to return if player object was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the player object to be tested
     ...
     *            name of the item stack
     * @param defaultValue
     *            default value to return if item stack was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the item stack to be tested
     ...
     *            name of the color
     * @param defaultValue
     *            default value to return if color was not found
     * @return value
     */
     ...
     * 
     * @param key
     *            name of the color to be tested
     ...
     *            name of the fragment object
     * @param defaultValue
     *            default value to return if fragment object was not found
     * @param <T>
     *            data fragment class
     * @return value
     */
     ...
     *            fragment class
     * @param key
     *            name of the fragment object to be tested
     * @param <T>
     *            data fragment class
     ...
     *            name of the enumeration
     * @param defaultValue
     *            default value to return if enumeration was not found
     * @param <T>
     *            enum class
