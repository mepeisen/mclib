 ...
 * <dd>not supported.</dd>
 * <dt>Arena-Rule</dt>
 * <dd>Passed to the arena calculated from firework location</dd>
 * <dt>Minigame-Rule</dt>
...
public interface McFireworkExplodeEvent extends MinecraftEvent<FireworkExplodeEvent, McFireworkExplodeEvent>
{
