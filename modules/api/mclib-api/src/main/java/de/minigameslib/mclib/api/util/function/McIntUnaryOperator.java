...
/**
 * Similar to {@link java.util.function.IntUnaryOperator} but is able to throw McExceptions.
 * 
 * @author mepeisen
 *
 */
@FunctionalInterface
public interface McIntUnaryOperator
{
     ...
     */
    int applyAsInt(int operand) throws McException;
     ...
     *             if before is null
     *
     * @see #andThen(McIntUnaryOperator)
     */
    default McIntUnaryOperator compose(McIntUnaryOperator before)
    {
     ...
     *             if after is null
     *
     * @see #compose(McIntUnaryOperator)
     */
    default McIntUnaryOperator andThen(McIntUnaryOperator after)
    {
     ...
     */
    static McIntUnaryOperator identity()
    {
        return t -> t;
    }
