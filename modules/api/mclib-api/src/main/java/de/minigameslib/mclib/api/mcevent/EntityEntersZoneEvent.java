...
/**
 * An event fired before an entity enters a zone.
 * 
 * <p>
 * This event can be cancelled. If cancelled the entity movement/teleport will be cancelled.
 * </p>
 * 
 * @author mepeisen
 */
public class EntityEntersZoneEvent extends AbstractVetoEvent
{
     ...
     *            the entity entering the zone
     */
    public EntityEntersZoneEvent(ZoneInterface zone, Entity entity)
    {
        this.zone = zone;
        this.entity = entity;
    }
