...
/**
 * An event fired before an entity leaves a zone.
 * 
 * <p>
 ...
 * @author mepeisen
 */
public class EntityLeavesZoneEvent extends AbstractVetoEvent
{
     ...
     *            the entity leaving the zone
     */
    public EntityLeavesZoneEvent(ZoneInterface zone, Entity entity)
    {
        this.zone = zone;
        this.entity = entity;
    }
