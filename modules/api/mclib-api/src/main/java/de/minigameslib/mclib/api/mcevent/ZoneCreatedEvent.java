...
/**
 * An event showing up that a zone was created.
 * 
 * @author mepeisen
 */
public class ZoneCreatedEvent extends Event implements MinecraftEvent<ZoneCreatedEvent, ZoneCreatedEvent>
{
     ...
     *            the created zone.
     */
    public ZoneCreatedEvent(ZoneInterface zone)
    {
        this.zone = zone;
    }
