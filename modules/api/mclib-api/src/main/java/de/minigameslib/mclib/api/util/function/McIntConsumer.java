...
/**
 * Similar to {@link java.util.function.IntConsumer} but is able to throw McExceptions.
 * 
 * @author mepeisen
 *
 */
@FunctionalInterface
public interface McIntConsumer
{
     ...
     */
    void accept(int value) throws McException;
    
    /**
     * Returns a composed {@code IntConsumer} that performs, in sequence, this operation followed by the {@code after} operation. If performing either operation throws an exception, it is relayed to
