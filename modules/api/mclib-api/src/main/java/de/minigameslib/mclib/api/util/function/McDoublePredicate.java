...
/**
 * Similar to {@link java.util.function.DoublePredicate} but is able to throw McExceptions.
 * 
 * @author mepeisen
 *
 */
@FunctionalInterface
public interface McDoublePredicate
{
     ...
     */
    boolean test(double value) throws McException;
     ...
     *             if other is null
     */
    default McDoublePredicate and(McDoublePredicate other)
    {
     ...
     */
    default McDoublePredicate negate()
    {
     ...
     *             if other is null
     */
    default McDoublePredicate or(McDoublePredicate other)
    {
        Objects.requireNonNull(other);
        return (value) -> test(value) || other.test(value);
    }
