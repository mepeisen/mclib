...
/**
 * Similar to {@link java.util.function.LongPredicate} but is able to throw McExceptions.
 * 
 * @author mepeisen
 *
 */
@FunctionalInterface
public interface McLongPredicate
{
     ...
     */
    boolean test(long value) throws McException;
     ...
     *             if other is null
     */
    default McLongPredicate and(McLongPredicate other)
    {
     ...
     */
    default McLongPredicate negate()
    {
     ...
     *             if other is null
     */
    default McLongPredicate or(McLongPredicate other)
    {
        Objects.requireNonNull(other);
        return (value) -> test(value) || other.test(value);
    }
