...
/**
 * An event showing up that an object was created.
 * 
 * @author mepeisen
 */
public class ObjectCreatedEvent extends Event implements MinecraftEvent<ObjectCreatedEvent, ObjectCreatedEvent>
{
     ...
     *            the created object.
     */
    public ObjectCreatedEvent(ObjectInterface object)
    {
        this.object = object;
    }
