...
public interface ConfigServiceInterface
{
     ...
     */
    ClickGuiItem createGuiEditorItem(EditableValue config, Runnable onChange, GuiItemHandler back, GuiItemHandler home, McRunnable contextProvider) throws McException;
