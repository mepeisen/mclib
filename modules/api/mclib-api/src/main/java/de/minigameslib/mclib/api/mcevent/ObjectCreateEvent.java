...
/**
 * An event fired before a new object is created.
 * 
 * <p>
 * This event can be cancelled. If cancelled the object will not be created.
 * </p>
 * 
 * @author mepeisen
 */
public class ObjectCreateEvent extends AbstractVetoEvent implements MinecraftEvent<ObjectCreateEvent, ObjectCreateEvent>
{
     ...
     *            the created object.
     */
    public ObjectCreateEvent(ObjectInterface object)
    {
        this.object = object;
    }
