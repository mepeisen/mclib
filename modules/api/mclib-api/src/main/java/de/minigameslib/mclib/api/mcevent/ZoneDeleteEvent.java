 ...
 * @author mepeisen
 */
public class ZoneDeleteEvent extends AbstractVetoEvent implements MinecraftEvent<ZoneDeleteEvent, ZoneDeleteEvent>
{
     ...
     *            the deleted zone.
     */
    public ZoneDeleteEvent(ZoneInterface zone)
    {
        this.zone = zone;
    }
