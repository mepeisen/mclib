...
/**
 * Test for {@link SignRelocateEvent}.
 * 
 * @author mepeisen
 */
public class SignRelocateEventTest
{
    ...
    public void testMe()
    {
        ...
        final SignRelocateEvent evt = new SignRelocateEvent(Sign,
        ...
        assertSame(evt.getHandlers(), SignRelocateEvent.getHandlerList());
