...
/**
 * Test for {@link ComponentDeletedEvent}.
 * 
 * @author mepeisen
 */
public class ComponentDeletedEventTest
{
    ...
    public void testMe()
    {
        ...
        final ComponentDeletedEvent evt = new ComponentDeletedEvent(Component);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ComponentDeletedEvent.getHandlerList());
