...
/**
 * Test for {@link EntityCreatedEvent}.
 * 
 * @author mepeisen
 */
public class EntityCreatedEventTest
{
    ...
    public void testMe()
    {
        ...
        final EntityCreatedEvent evt = new EntityCreatedEvent(Entity);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), EntityCreatedEvent.getHandlerList());
