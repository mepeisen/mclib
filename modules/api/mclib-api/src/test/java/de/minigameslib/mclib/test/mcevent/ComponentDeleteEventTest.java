...
/**
 * Test for {@link ComponentDeleteEvent}.
 * 
 * @author mepeisen
 */
public class ComponentDeleteEventTest
{
    ...
    public void testMe()
    {
        ...
        final ComponentDeleteEvent evt = new ComponentDeleteEvent(Component);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ComponentDeleteEvent.getHandlerList());
