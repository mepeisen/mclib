...
public class ConfigurationValueInterfaceTest
{
    ...
    public void getsetTest()
    {
        ...
        try
        {
            ...
            TestOptions.SomeItemStackList.setItemStackList(new DummyItemStackData[] {
                new DummyItemStackData(new ItemStack(Material.ACACIA_DOOR_ITEM)),
                new DummyItemStackData(new ItemStack(Material.ACACIA_FENCE))
            });
            TestOptions.SomeOtherItemStackList.setItemStackList(new DummyItemStackData[] {
                new DummyItemStackData(new ItemStack(Material.ACACIA_FENCE_GATE)),
                new DummyItemStackData(new ItemStack(Material.ACACIA_STAIRS))
            });
            ...
            assertArrayEquals(new ConfigItemStackData[] {
                new DummyItemStackData(new ItemStack(Material.ACACIA_DOOR_ITEM)),
                new DummyItemStackData(new ItemStack(Material.ACACIA_FENCE))
            }, TestOptions.SomeItemStackList.getItemStackList());
            assertArrayEquals(new ConfigItemStackData[] {
                new DummyItemStackData(new ItemStack(Material.ACACIA_FENCE_GATE)),
                new DummyItemStackData(new ItemStack(Material.ACACIA_STAIRS))
            }, TestOptions.SomeOtherItemStackList.getItemStackList());
            ...
            assertArrayEquals(new ConfigColorData[] {
                ConfigColorData.fromBukkitColor(Color.BLUE),
                ConfigColorData.fromBukkitColor(Color.GREEN)
            }, TestOptions.SomeSection.getColorList("ColorList")); //$NON-NLS-1$
            ...
            TestOptions.SomeSection.setItemStackList(new DummyItemStackData[] {
                new DummyItemStackData(new ItemStack(Material.ACACIA_DOOR_ITEM)),
                new DummyItemStackData(new ItemStack(Material.ACACIA_FENCE))
            }, "ItemStackList"); //$NON-NLS-1$
            assertTrue(TestOptions.SomeSection.isset("ItemStackList")); //$NON-NLS-1$
            assertArrayEquals(new DummyItemStackData[] {
                new DummyItemStackData(new ItemStack(Material.ACACIA_DOOR_ITEM)),
                new DummyItemStackData(new ItemStack(Material.ACACIA_FENCE))
            }, TestOptions.SomeSection.getItemStackList("ItemStackList")); //$NON-NLS-1$
            ...
            assertArrayEquals(new String[] { "3", "4" }, //$NON-NLS-1$ //$NON-NLS-2$
                TestOptions.SomeSection.getStringList("StringList", new String[] { "3", "4" })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            ...
            assertArrayEquals(new String[] { "4", "5" }, //$NON-NLS-1$ //$NON-NLS-2$
                TestOptions.SomeSection.getStringList("StringList", new String[] { "3", "4" })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
