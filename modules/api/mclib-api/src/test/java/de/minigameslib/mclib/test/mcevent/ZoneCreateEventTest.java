...
/**
 * Test for {@link ZoneCreateEvent}.
 * 
 * @author mepeisen
 */
public class ZoneCreateEventTest
{
    ...
    public void testMe()
    {
        ...
        final ZoneCreateEvent evt = new ZoneCreateEvent(zone);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), ZoneCreateEvent.getHandlerList());
