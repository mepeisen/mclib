...
/**
 * Tests case for {@link McDoublePredicate}.
 * 
 * @author mepeisen
 */
public class McDoublePredicateTest
{
    
    /**
     * Tests method {@link McDoublePredicate#and(McDoublePredicate)}
     * 
     * @throws McException
     *             thrown on errors.
     */
    ...
    {
        final McDoublePredicate func = (l) -> l > 10;
        final McDoublePredicate func2 = (l) -> l > 20;
    ...
    /**
     * Tests method {@link McDoublePredicate#or(McDoublePredicate)}
     * 
     * @throws McException
     *             thrown on errors.
     */
    ...
    {
        final McDoublePredicate func = (l) -> l > 10;
        final McDoublePredicate func2 = (l) -> l < -10;
    ...
    /**
     * Tests method {@link McDoublePredicate#negate()}
     * 
     * @throws McException
     *             thrown on errors.
     */
