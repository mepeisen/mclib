...
/**
 * Test for {@link ComponentRelocatedEvent}.
 * 
 * @author mepeisen
 */
public class ComponentRelocatedEventTest
{
    ...
    public void testMe()
    {
        ...
        final ComponentRelocatedEvent evt = new ComponentRelocatedEvent(Component,
        ...
        assertSame(evt.getHandlers(), ComponentRelocatedEvent.getHandlerList());
