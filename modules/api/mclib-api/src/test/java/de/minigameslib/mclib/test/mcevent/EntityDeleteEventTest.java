...
/**
 * Test for {@link EntityDeleteEvent}.
 * 
 * @author mepeisen
 */
public class EntityDeleteEventTest
{
    ...
    public void testMe()
    {
        ...
        final EntityDeleteEvent evt = new EntityDeleteEvent(Entity);
        
        assertSame(evt, evt.getBukkitEvent());
        assertSame(evt.getHandlers(), EntityDeleteEvent.getHandlerList());
