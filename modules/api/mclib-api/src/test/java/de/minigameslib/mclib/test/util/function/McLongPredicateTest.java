...
/**
 * Tests case for {@link McLongPredicate}
 * 
 * @author mepeisen
 */
public class McLongPredicateTest
{
    
    /**
     * Tests method {@link McLongPredicate#and(McLongPredicate)}
     * 
     * @throws McException
     *             thrown on errors.
     */
    ...
    {
        final McLongPredicate func = (l) -> l > 10;
        final McLongPredicate func2 = (l) -> l > 20;
    ...
    /**
     * Tests method {@link McLongPredicate#or(McLongPredicate)}
     * 
     * @throws McException
     *             thrown on errors.
     */
    ...
    {
        final McLongPredicate func = (l) -> l > 10;
        final McLongPredicate func2 = (l) -> l < -10;
    ...
    /**
     * Tests method {@link McLongPredicate#negate()}
     * 
     * @throws McException
     *             thrown on errors.
     */
