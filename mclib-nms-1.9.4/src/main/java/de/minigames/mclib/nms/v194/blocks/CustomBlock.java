...
public class CustomBlock extends Block
{
    ...
    public boolean interact(World paramWorld, BlockPosition paramBlockPosition, IBlockData paramIBlockData,
        net.minecraft.server.v1_9_R2.EntityHuman paramEntityHuman, net.minecraft.server.v1_9_R2.EnumHand paramEnumHand, ItemStack itemStack,
        net.minecraft.server.v1_9_R2.EnumDirection paramEnumDirection, float paramFloat1,
    ...
    @Override
    public net.minecraft.server.v1_9_R2.Item getDropType(IBlockData iblockdata, Random random, int i)
    {
        return this.dropRule == null ? super.getDropType(iblockdata, random, i) : net.minecraft.server.v1_9_R2.Item.getById(this.dropRule.getDropType(this.toLegacyData(iblockdata), random, i));
    }
    ...
    @Override
    public int getExpDrop(net.minecraft.server.v1_9_R2.World world, IBlockData data, int i)
    {
