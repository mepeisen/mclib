 ...
 *
 */
public class EntityHelper1_9_4 implements EntityHelperInterface
{
    ...
    /** dummy humans. */
    private static final EntityWithWhitelistHelper<DummyHuman1_9_4.EntityHelper> HUMANS     = new EntityWithWhitelistHelper<>();
    ...
    public Villager spawnDummyVillager(Location loc, Profession profession)
    {
        try
        {
            CustomEntityType1_9_4.DUMMY_VILLAGER.registerEntity();
            final DummyVillager1_9_4 villager = new DummyVillager1_9_4(((CraftWorld) loc.getWorld()).getHandle());
        ...
        {
            CustomEntityType1_9_4.DUMMY_VILLAGER.unregisterEntity();
        }
    }
    ...
    public HumanEntity spawnDummyHuman(Location loc, String name, String skinTexture)
    {
        ...
        final DummyHuman1_9_4 result = new DummyHuman1_9_4(server, world.getHandle(), profile, new PlayerInteractManager(world.getHandle()), loc);
    ...
    {
        final DummyHuman1_9_4 human = (DummyHuman1_9_4) ((CraftPlayer) entity).getHandle();
    ...
    {
        return villager instanceof DummyVillager1_9_4.VillagerNPC;
    }
    
    @Override
    public boolean isDummyHuman(HumanEntity human)
    {
        return human instanceof DummyHuman1_9_4.HumanNpc;
    }
