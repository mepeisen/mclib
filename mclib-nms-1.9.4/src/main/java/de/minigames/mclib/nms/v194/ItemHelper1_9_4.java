...
import de.minigames.mclib.nms.v194.blocks.CustomDropper;
import de.minigames.mclib.nms.v194.blocks.CustomHopper;
...
import net.minecraft.server.v1_9_R2.RecipesFurnace;
...
public class ItemHelper1_9_4 implements ItemHelperInterface
{
    ...
    public void setBlockVariant(Block block, int type, int variant)
    {
        ...
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(type);
        @SuppressWarnings("deprecation")
    ...
    public void initBlocks()
    {
        try
        {
            final Method itemMth = Item.class.getDeclaredMethod("a", net.minecraft.server.v1_9_R2.Block.class, Item.class); //$NON-NLS-1$
            ...
            for (int i = MclibConstants.MIN_BLOCK_ID; i <= MclibConstants.MAX_BLOCK_ID; i++)
            {
                ...
                itemMth.invoke(null, myBlock, new ItemMultiTexture(myBlock, myBlock, new Function<net.minecraft.server.v1_9_R2.ItemStack, String>() {
                    @Override
                    @Nullable
                    public String apply(@Nullable net.minecraft.server.v1_9_R2.ItemStack paramItemStack)
                    {
    ...
    public ItemStack addToInventory(Inventory inventory, ItemStack item)
    {
        ...
        while (true)
        {
            ...
            if (firstPartial == -1)
            {
                ...
                InventoryManager1_9_4.setContents((CraftInventory) inventory, item, firstFree);
                break;
            }
            ...
            if (amount + partialAmount <= maxAmount)
            {
                ...
                InventoryManager1_9_4.setContents((CraftInventory) inventory, partialItem, firstPartial);
                break;
            }
     ...
     */
    private void replaceModdedBlock(int numBlockId, net.minecraft.server.v1_9_R2.Block block)
    {
        try
        {
            final Field bMapField = net.minecraft.server.v1_9_R2.RegistryMaterials.class.getDeclaredField("b"); //$NON-NLS-1$
            bMapField.setAccessible(true);
            @SuppressWarnings("unchecked")
            final Map<net.minecraft.server.v1_9_R2.Block, MinecraftKey> bMap = (Map<net.minecraft.server.v1_9_R2.Block, MinecraftKey>) bMapField.get(net.minecraft.server.v1_9_R2.Block.REGISTRY);
            
            final Field aMapField = net.minecraft.server.v1_9_R2.RegistryMaterials.class.getDeclaredField("a"); //$NON-NLS-1$
            aMapField.setAccessible(true);
            @SuppressWarnings("unchecked")
            final RegistryID<net.minecraft.server.v1_9_R2.Block> aMap = (RegistryID<net.minecraft.server.v1_9_R2.Block>) aMapField.get(net.minecraft.server.v1_9_R2.Block.REGISTRY);
            
            bMap.put(block, bMap.remove(net.minecraft.server.v1_9_R2.Block.getById(numBlockId)));
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PUMPKIN;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PUMPKIN;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CORAL;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CORAL;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.GRASS;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.GRASS;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.WOOD;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.WOOD;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.STONE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.STONE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.ORE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.ORE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.HEAVY;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.HEAVY;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.WATER;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.WATER;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.LAVA;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.LAVA;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.LEAVES;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.LEAVES;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.REPLACEABLE_PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.REPLACEABLE_PLANT;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SPONGE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SPONGE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CLOTH;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CLOTH;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.FIRE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.FIRE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SAND;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SAND;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.ORIENTABLE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.ORIENTABLE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.WOOL;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.WOOL;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SHATTERABLE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SHATTERABLE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.BUILDABLE_GLASS;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.BUILDABLE_GLASS;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.TNT;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.TNT;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.ICE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.ICE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PACKED_ICE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PACKED_ICE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SNOW_LAYER;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SNOW_LAYER;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SNOW_BLOCK;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.SNOW_BLOCK;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CACTUS;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CACTUS;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CLAY;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CLAY;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.DRAGON_EGG;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.DRAGON_EGG;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PORTAL;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PORTAL;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CAKE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.CAKE;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.WEB;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.WEB;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PISTON;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.PISTON;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.getById(material.getId());
        return block.q(block.getBlockData()) == net.minecraft.server.v1_9_R2.Material.BANNER;
    }
    ...
    {
        final net.minecraft.server.v1_9_R2.Block nms = net.minecraft.server.v1_9_R2.Block.getById(block);
        return nms.q(nms.getBlockData()) == net.minecraft.server.v1_9_R2.Material.BANNER;
    }
    ...
    public Map<String, Integer> getBlockMappings()
    {
        ...
        for (final MinecraftKey key : net.minecraft.server.v1_9_R2.Block.REGISTRY.keySet())
        {
            final String name = key.toString();
            for (int i = 0; i < 16; i++)
            {
                final net.minecraft.server.v1_9_R2.Block block = net.minecraft.server.v1_9_R2.Block.REGISTRY.get(key);
                final int numid = net.minecraft.server.v1_9_R2.Block.REGISTRY.a(block);
    ...
    public ChunkDataImpl getChunkSnapshot(Chunk chunk)
    {
        ...
        final net.minecraft.server.v1_9_R2.Chunk handle = ((CraftChunk)chunk).getHandle();
        ...
        for (int x = 0; x < 16; x++)
        {
            ...
            for (int y = 0; y < 256; y++)
            {
                ...
                for (int z = 0; z < 16; z++)
                {
                    ...
                    blockData[x][y][z] = net.minecraft.server.v1_9_R2.Block.REGISTRY_ID.getId(data);
                }
            }
        }
