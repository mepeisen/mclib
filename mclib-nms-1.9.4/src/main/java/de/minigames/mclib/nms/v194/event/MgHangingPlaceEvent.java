...
import de.minigameslib.mclib.api.event.McHangingPlaceEvent;
...
public class MgHangingPlaceEvent extends AbstractMinigameEvent<HangingPlaceEvent, McHangingPlaceEvent> implements McHangingPlaceEvent
{
     ...
     * @return player
     */
    private static McPlayerInterface player(HangingPlaceEvent event)
    {
        final Player passenger = event.getPlayer();
        return passenger == null ? null : ObjectServiceInterface.instance().getPlayer(passenger);
    }
