 ...
 * @author mepeisen
 */
public class MgPlayerMoveEvent extends AbstractMinigameEvent<PlayerMoveEvent, McPlayerMoveEvent> implements McPlayerMoveEvent
{
     ...
     *            the bukkit event
     */
    public MgPlayerMoveEvent(PlayerMoveEvent event)
    {
