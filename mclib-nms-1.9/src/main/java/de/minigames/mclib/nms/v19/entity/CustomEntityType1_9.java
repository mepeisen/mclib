 ...
 * @see EntityTypes
 */
public enum CustomEntityType1_9
{
    
    /** a dummy villager. */
    DUMMY_VILLAGER("Villager", 120, EntityType.VILLAGER, EntityVillager.class, DummyVillager1_9.class); //$NON-NLS-1$
    ...
    /** logger. */
    private static final Logger               LOGGER = Logger.getLogger(CustomEntityType1_9.class.getName());
     ...
     *            custom class
     */
    private CustomEntityType1_9(String name, int id, EntityType entityType, Class<? extends EntityInsentient> nmsClass, Class<? extends EntityInsentient> customClass)
    {
        this.name = name;
        this.id = id;
    ...
    {
        for (CustomEntityType1_9 entity : values())
        {
